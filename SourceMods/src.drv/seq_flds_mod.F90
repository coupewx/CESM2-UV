...
contains
  ...
  subroutine seq_flds_set(nmlfile, ID, infodata)
    ...
    call seq_flds_add(a2x_states,"Sa_ephyto1" )
    call seq_flds_add(x2i_states,"Sa_ephyto1" )
    call seq_flds_add(x2l_states,"Sa_ephyto1" )
    call seq_flds_add(x2o_states,"Sa_ephyto1" )
    longname = 'Phytoplankton photoinhibition, Phaeodactylum'
    stdname  = 'phtytoplankton_photoinhibition_phaeodactylum'
    units    = '1'
    attname  = 'Sa_ephyto1'
    call metadata_set(attname, longname, stdname, units)

    ! Phytoplankton Photoinhibition, Phaeadactylum (Cullen, 1992)
    call seq_flds_add(a2x_states,"Sa_ephyto1_net" )
    call seq_flds_add(x2i_states,"Sa_ephyto1_net" )
    call seq_flds_add(x2l_states,"Sa_ephyto1_net" )
    call seq_flds_add(x2o_states,"Sa_ephyto1_net" )
    longname = 'Phytoplankton photoinhibition, Phaeodactylum'
    stdname  = 'phtytoplankton_photoinhibition_phaeodactylum'
    units    = '1'
    attname  = 'Sa_ephyto1_net'
    call metadata_set(attname, longname, stdname, units)
    ...
    call seq_flds_add(a2x_states,"Sa_ephyto4" )
    call seq_flds_add(x2i_states,"Sa_ephyto4" )
    call seq_flds_add(x2l_states,"Sa_ephyto4" )
    call seq_flds_add(x2o_states,"Sa_ephyto4" )
    ...
    call seq_flds_add(a2x_states,"Sa_ephyto5" )
    call seq_flds_add(x2i_states,"Sa_ephyto5" )
    call seq_flds_add(x2l_states,"Sa_ephyto5" )
    call seq_flds_add(x2o_states,"Sa_ephyto5" )
