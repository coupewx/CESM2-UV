...
contains
  ...
  subroutine prep_ocn_merge( flux_epbalfact, a2x_o, i2x_o, r2x_o, w2x_o, g2x_o, xao_o, &
    ...
    integer, save :: index_a2x_Sa_ephyto1 ! cullen e*inh for diatoms
    ...
    if (first_time) then
       ...
       do ko = 1,noflds
          ...
          if (trim(field_ocn(ko)) == 'Foxx_swnet' .or. &
               ...
               trim(field_ocn(ko)) == 'Sa_ephyto1_net' .or. &
               trim(field_ocn(ko)) == 'Sa_ephyto5_net' .or. &
               trim(field_ocn(ko)) == 'Sa_ephyto4_net' .or. &
    ...
    do n = 1,lsize
      ...
      ! coupe adding albedo to ephyto1 (ephyto1_net)
      ! coupe adding albedo to ephyto1 (ephyto1_net) - note avsdr is direct visible albedo
       incoming_ephyto1 = a2x_o%rAttr(index_a2x_Sa_ephyto1,n)
       x2o_o%rAttr(index_x2o_Sa_ephyto1_net,n) = incoming_ephyto1*(1.0_R8 - avsdr)*(1.0_R8 -ifrac)
       incoming_ephyto4 = a2x_o%rAttr(index_a2x_Sa_ephyto4,n)
       x2o_o%rAttr(index_x2o_Sa_ephyto4_net,n) = incoming_ephyto4*(1.0_R8 - avsdr)*(1.0_R8 -ifrac)
       incoming_ephyto5 = a2x_o%rAttr(index_a2x_Sa_ephyto5,n)
       x2o_o%rAttr(index_x2o_Sa_ephyto5_net,n) = incoming_ephyto5*(1.0_R8 - avsdr)*(1.0_R8 -ifrac)
