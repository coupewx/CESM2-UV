...
!-----------------------------------------------------------------------
   ...
   integer :: uva_idx, uvb_idx, par_idx,par_fake_idx, ephyto1_idx, ephyto2_idx, ephyto4_idx, ephyto5_idx
   ...
   ephyto1_idx = pbuf_get_index('TUV_PHYTOPHAEO92', errcode=i)
   ...
   if (ephyto1_idx > 0) then
     call pbuf_get_field(pbuf, ephyto1_idx, ephyto1)
   end if
   if (ephyto2_idx > 0) then
     call pbuf_get_field(pbuf, ephyto2_idx, ephyto2)
   end if
   !if (ephyto3_idx > 0) then
   !  call pbuf_get_field(pbuf, ephyto3_idx, ephyto3)
   !end if
   if (ephyto4_idx > 0) then
     call pbuf_get_field(pbuf, ephyto4_idx, ephyto4)
   end if
   if (ephyto5_idx > 0) then
     call pbuf_get_field(pbuf, ephyto5_idx, ephyto5)
   end if
