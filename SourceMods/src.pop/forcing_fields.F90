...
! !PUBLIC DATA MEMBERS:
  ...
  integer(kind=int_kind), public :: &
   ...
   real (r8), dimension(nx_block,ny_block,max_blocks_clinic), &
      public, target ::  &
      ATM_PAR,           &! photosynthetic active radiation from atm from cpl (W/m2)
      ATM_PAR_FAKE,      &! FAKE photosynthetic active radiation from atm from cpl (W/m2)
      ATM_EPHYTO1,       &! photoinhibition, Phaeo from atm from cpl
      ATM_EPHYTO1_NET,   &
      ATM_EPHYTO2,       &! photoinhibition, Proro from atm from cpl
      ATM_EPHYTO3,       & ! photoinhibition, Boucher from atm from cpl
      ATM_EPHYTO4,       &        ! photoinhibition, Neale and Thomas from atm from cpl
      ATM_EPHYTO4_NET, &
      ATM_EPHYTO5, &
      ATM_EPHYTO5_NET
