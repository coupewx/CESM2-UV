...
!BOC
   ...
   integer (int_kind) :: &
      ...
      tavg_ATM_EPHYTO1,       &! photoinhibition, Phaeo from atm from cpl
      tavg_ATM_EPHYTO1_NET,       &
      tavg_ATM_EPHYTO2,       &! photoinhibition, Proro from atm from cpl
      !tavg_ATM_EPHYTO3,       &! photoinhibition, Boucher from atm from cpl
      tavg_ATM_EPHYTO4,       & !photoinhibition, Neale and Thomas
      tavg_ATM_EPHYTO4_NET,   &
      tavg_ATM_EPHYTO5,   &
      tavg_ATM_EPHYTO5_NET 
