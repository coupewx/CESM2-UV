module POP_CplIndices
  ...
  integer ::  index_x2o_Faxa_par       ! photosynthetic avaialble radiation (W/m2)
  !integer ::  index_x2o_Faxa_par_fake  ! FAKE photosynthetic avaialble radiation (W/m2)  
  !integer ::  index_x2o_Sa_ephyto1     ! photoinhibition, phytoplankton, phaeo (diatom)
  !integer ::  index_x2o_Sa_ephyto1_net     ! photoinhibition, phytoplankton, phaeo (diatom)
  !integer ::  index_x2o_Sa_ephyto2     ! photoinhibition, phytoplankton, proro (dinoflagelate)
  !integer ::  index_x2o_Sa_ephyto3     ! photoinhibition, phytoplankton, Boucher(1994) (antarctic)
  !integer :: index_x2o_Sa_ephyto4      ! photoinhibition, phytoplankton, Neale and Thomas (2017)
  !integer :: index_x2o_Sa_ephyto4_net      ! photoinhibition, phytoplankton, Neale and Thomas (2017)
  !integer :: index_x2o_Sa_ephyto5      ! photoinhibition, phytoplankton, Lorenzo et al. (@019)
  !integer :: index_x2o_Sa_ephyto5_net      ! photoinhibition, phytoplankton, Lorenzo et al. (@019)
  integer ::  index_x2o_Sa_ephyto1UVA     ! photoinhibition, phytoplankton, phaeo (diatom)
  integer ::  index_x2o_Sa_ephyto1UVB
  integer ::  index_x2o_Sa_ephyto1UVC
  integer ::  index_x2o_Sa_ephyto1UVA_net     
  integer ::  index_x2o_Sa_ephyto1UVB_net
  integer ::  index_x2o_Sa_ephyto1UVC_net

  integer :: index_x2o_Sa_ephyto4UVA      ! photoinhibition, prochlorococcus, Neale and Thomas (2017)
  integer :: index_x2o_Sa_ephyto4UVB
  integer :: index_x2o_Sa_ephyto4UVC
  integer :: index_x2o_Sa_ephyto4UVA_net      
  integer :: index_x2o_Sa_ephyto4UVB_net
  integer :: index_x2o_Sa_ephyto4UVC_net

  integer :: index_x2o_Sa_ephyto5UVA      ! photoinhibition, phytoplankton, Lorenzo et al. (2019)
  integer :: index_x2o_Sa_ephyto5UVB
  integer :: index_x2o_Sa_ephyto5UVC
  integer :: index_x2o_Sa_ephyto5UVA_net      
  integer :: index_x2o_Sa_ephyto5UVB_net
  integer :: index_x2o_Sa_ephyto5UVC_net

  !integer :: index_x2o_Sa_ephyto6UVA      ! photoinhibition, coccolithophores, Guan and Gao (2010)
  !integer :: index_x2o_Sa_ephyto6UVB
  !integer :: index_x2o_Sa_ephyto6UVC
  !integer :: index_x2o_Sa_ephyto6UVA_net      
  !integer :: index_x2o_Sa_ephyto6UVB_net
  !integer :: index_x2o_Sa_ephyto6UVC_net

  integer :: index_x2o_Sa_ephyto7UVA      ! photoinhibition, synechococcus, Neale and Thomas (2017)
  integer :: index_x2o_Sa_ephyto7UVB
  integer :: index_x2o_Sa_ephyto7UVC
  integer :: index_x2o_Sa_ephyto7UVA_net      
  integer :: index_x2o_Sa_ephyto7UVB_net
  integer :: index_x2o_Sa_ephyto7UVC_net
...
contains
  ...
  subroutine POP_CplIndicesSet( )
    ...
    index_x2o_Faxa_par      = mct_avect_indexra(x2o,'Faxa_par',perrWith='quiet')
    !index_x2o_Faxa_par_fake     = mct_avect_indexra(x2o,'Faxa_par_fake',perrWith='quiet')
    !index_x2o_Sa_ephyto1    = mct_avect_indexra(x2o,'Sa_ephyto1',perrWith='quiet')
    !index_x2o_Sa_ephyto1_net = mct_avect_indexra(x2o,'Sa_ephyto1_net',perrWith='quiet')
    !index_x2o_Sa_ephyto2    = mct_avect_indexra(x2o,'Sa_ephyto2',perrWith='quiet')
    !index_x2o_Sa_ephyto3    = mct_avect_indexra(x2o,'Sa_ephyto3',perrWith='quiet')
    !index_x2o_Sa_ephyto4    = mct_avect_indexra(x2o,'Sa_ephyto4',perrWith='quiet')
    !index_x2o_Sa_ephyto4_net    = mct_avect_indexra(x2o,'Sa_ephyto4_net',perrWith='quiet')
    !index_x2o_Sa_ephyto5    = mct_avect_indexra(x2o,'Sa_ephyto5',perrWith='quiet')
    !index_x2o_Sa_ephyto5_net    = mct_avect_indexra(x2o,'Sa_ephyto5_net',perrWith='quiet')


    index_x2o_Sa_ephyto1UVA    = mct_avect_indexra(x2o,'Sa_ephyto1UVA',perrWith='quiet')
    index_x2o_Sa_ephyto1UVB    = mct_avect_indexra(x2o,'Sa_ephyto1UVB',perrWith='quiet')
    index_x2o_Sa_ephyto1UVC    = mct_avect_indexra(x2o,'Sa_ephyto1UVC',perrWith='quiet')
    index_x2o_Sa_ephyto1UVA_net    = mct_avect_indexra(x2o,'Sa_ephyto1UVA_net',perrWith='quiet')
    index_x2o_Sa_ephyto1UVB_net  = mct_avect_indexra(x2o,'Sa_ephyto1UVB_net',perrWith='quiet')
    index_x2o_Sa_ephyto1UVC_net    = mct_avect_indexra(x2o,'Sa_ephyto1UVC_net',perrWith='quiet')

    index_x2o_Sa_ephyto4UVA    = mct_avect_indexra(x2o,'Sa_ephyto4UVA',perrWith='quiet')
    index_x2o_Sa_ephyto4UVB    = mct_avect_indexra(x2o,'Sa_ephyto4UVB',perrWith='quiet')
    index_x2o_Sa_ephyto4UVC    = mct_avect_indexra(x2o,'Sa_ephyto4UVC',perrWith='quiet')
    index_x2o_Sa_ephyto4UVA_net    = mct_avect_indexra(x2o,'Sa_ephyto4UVA_net',perrWith='quiet')
    index_x2o_Sa_ephyto4UVB_net  = mct_avect_indexra(x2o,'Sa_ephyto4UVB_net',perrWith='quiet')
    index_x2o_Sa_ephyto4UVC_net    = mct_avect_indexra(x2o,'Sa_ephyto4UVC_net',perrWith='quiet')

    index_x2o_Sa_ephyto5UVA    = mct_avect_indexra(x2o,'Sa_ephyto5UVA',perrWith='quiet')
    index_x2o_Sa_ephyto5UVB    = mct_avect_indexra(x2o,'Sa_ephyto5UVB',perrWith='quiet')
    index_x2o_Sa_ephyto5UVC    = mct_avect_indexra(x2o,'Sa_ephyto5UVC',perrWith='quiet')
    index_x2o_Sa_ephyto5UVA_net    = mct_avect_indexra(x2o,'Sa_ephyto5UVA_net',perrWith='quiet')
    index_x2o_Sa_ephyto5UVB_net  = mct_avect_indexra(x2o,'Sa_ephyto5UVB_net',perrWith='quiet')
    index_x2o_Sa_ephyto5UVC_net    = mct_avect_indexra(x2o,'Sa_ephyto5UVC_net',perrWith='quiet')

    !index_x2o_Sa_ephyto6UVA    = mct_avect_indexra(x2o,'Sa_ephyto6UVA',perrWith='quiet')
    !index_x2o_Sa_ephyto6UVB    = mct_avect_indexra(x2o,'Sa_ephyto6UVB',perrWith='quiet')
    !index_x2o_Sa_ephyto6UVC    = mct_avect_indexra(x2o,'Sa_ephyto6UVC',perrWith='quiet')
    !index_x2o_Sa_ephyto6UVA_net    = mct_avect_indexra(x2o,'Sa_ephyto6UVA_net',perrWith='quiet')
    !index_x2o_Sa_ephyto6UVB_net  = mct_avect_indexra(x2o,'Sa_ephyto6UVB_net',perrWith='quiet')
    !index_x2o_Sa_ephyto6UVC_net    = mct_avect_indexra(x2o,'Sa_ephyto6UVC_net',perrWith='quiet')

    index_x2o_Sa_ephyto7UVA    = mct_avect_indexra(x2o,'Sa_ephyto7UVA',perrWith='quiet')
    index_x2o_Sa_ephyto7UVB    = mct_avect_indexra(x2o,'Sa_ephyto7UVB',perrWith='quiet')
    index_x2o_Sa_ephyto7UVC    = mct_avect_indexra(x2o,'Sa_ephyto7UVC',perrWith='quiet')
    index_x2o_Sa_ephyto7UVA_net    = mct_avect_indexra(x2o,'Sa_ephyto7UVA_net',perrWith='quiet')
    index_x2o_Sa_ephyto7UVB_net  = mct_avect_indexra(x2o,'Sa_ephyto7UVB_net',perrWith='quiet')
    index_x2o_Sa_ephyto7UVC_net    = mct_avect_indexra(x2o,'Sa_ephyto7UVC_net',perrWith='quiet')
