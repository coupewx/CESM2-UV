module marbl_interface_private_types
  ...
  type, public :: marbl_interior_tendency_forcing_indexing_type
     ...
     integer(int_kind) :: EPHYTO1UVA_col_frac_id =0
     integer(int_kind) :: EPHYTO1UVB_col_frac_id =0
     integer(int_kind) :: EPHYTO1UVC_col_frac_id =0
     integer(int_kind) :: EPHYTO4UVA_col_frac_id =0
     integer(int_kind) :: EPHYTO4UVB_col_frac_id =0
     integer(int_kind) :: EPHYTO4UVC_col_frac_id =0
     integer(int_kind) :: EPHYTO5UVA_col_frac_id =0
     integer(int_kind) :: EPHYTO5UVB_col_frac_id =0
     integer(int_kind) :: EPHYTO5UVC_col_frac_id =0
     integer(int_kind) :: EPHYTO7UVA_col_frac_id =0
     integer(int_kind) :: EPHYTO7UVB_col_frac_id =0
     integer(int_kind) :: EPHYTO7UVC_col_frac_id =0
     ! NOW DO NET SURFACE FORCING FIELDS
     integer(int_kind) :: EPHYTO1UVA_NET_col_frac_id =0
     integer(int_kind) :: EPHYTO1UVB_NET_col_frac_id =0
     integer(int_kind) :: EPHYTO1UVC_NET_col_frac_id =0
     integer(int_kind) :: EPHYTO4UVA_NET_col_frac_id =0
     integer(int_kind) :: EPHYTO4UVB_NET_col_frac_id =0
     integer(int_kind) :: EPHYTO4UVC_NET_col_frac_id =0
     integer(int_kind) :: EPHYTO5UVA_NET_col_frac_id =0
     integer(int_kind) :: EPHYTO5UVB_NET_col_frac_id =0
     integer(int_kind) :: EPHYTO5UVC_NET_col_frac_id =0
     integer(int_kind) :: EPHYTO7UVA_NET_col_frac_id =0
     integer(int_kind) :: EPHYTO7UVB_NET_col_frac_id =0
     integer(int_kind) :: EPHYTO7UVC_NET_col_frac_id =0
     !integer(int_kind) :: EPHYTO1_col_frac_id =0  ! COUPE new UV inhibition term ephyto1
     !integer(int_kind) :: EPHYTO1_NET_col_frac_id =0
     !integer(int_kind) :: EPHYTO3_col_frac_id=0   ! COUPE added Boucher (1994) inhibition term ephyto3
     !integer(int_kind) :: EPHYTO4_col_frac_id=0   ! COUPE added NEale and Thomas (2017) inhibition term ephyto4
     !integer(int_kind) :: EPHYTO4_NET_col_frac_id=0 
     !integer(int_kind) :: EPHYTO5_col_frac_id=0 ! Lorenzo et al (2019) coccolithophore inhibition ephyto5
     !integer(int_kind) :: EPHYTO5_NET_col_frac_id=0 
     ! Column fields
  ...
  type, public :: marbl_interior_tendency_diagnostics_indexing_type
    ...
    integer(int_kind), allocatable :: x_graze_zoo(:)
     ...
     ! add TUV terms to MARBL diagnostics
     !integer (int_kind) :: ATM_EPHYTO1 ! Cullen et al. (1992) ephyto1
     !integer (int_kind) :: ATM_EPHYTO1_NET ! cullen eephyto1 net 
     !integer (int_kind) :: ATM_EPHYTO3 ! Boucher et al. (1994) ephyto3
     !integer (int_kind) :: ATM_EPHYTO4 ! Neale and Thomas (2017) ephyto4
     !integer (int_kind) :: ATM_EPHYTO4_NET
     !integer (int_kind) :: ATM_EPHYTO5 ! Lorenzo et al. (2019) ephyto5
     !integer (int_kind) :: ATM_EPHYTO5_NET
     integer (int_kind) :: ATM_EPHYTO1UVA 
     integer (int_kind) :: ATM_EPHYTO1UVA_NET 
     integer (int_kind) :: ATM_EPHYTO1UVB 
     integer (int_kind) :: ATM_EPHYTO1UVB_NET 
     integer (int_kind) :: ATM_EPHYTO1UVC 
     integer (int_kind) :: ATM_EPHYTO1UVC_NET
     integer (int_kind) :: ATM_EPHYTO4UVA 
     integer (int_kind) :: ATM_EPHYTO4UVA_NET 
     integer (int_kind) :: ATM_EPHYTO4UVB 
     integer (int_kind) :: ATM_EPHYTO4UVB_NET 
     integer (int_kind) :: ATM_EPHYTO4UVC 
     integer (int_kind) :: ATM_EPHYTO4UVC_NET
     integer (int_kind) :: ATM_EPHYTO5UVA 
     integer (int_kind) :: ATM_EPHYTO5UVA_NET 
     integer (int_kind) :: ATM_EPHYTO5UVB 
     integer (int_kind) :: ATM_EPHYTO5UVB_NET 
     integer (int_kind) :: ATM_EPHYTO5UVC 
     integer (int_kind) :: ATM_EPHYTO5UVC_NET 
     integer (int_kind) :: ATM_EPHYTO7UVA 
     integer (int_kind) :: ATM_EPHYTO7UVA_NET 
     integer (int_kind) :: ATM_EPHYTO7UVB 
     integer (int_kind) :: ATM_EPHYTO7UVB_NET 
     integer (int_kind) :: ATM_EPHYTO7UVC 
     integer (int_kind) :: ATM_EPHYTO7UVC_NET  
   contains
...
!      ! UV inhibition - Cullen et al. (1994)
!      forcing_cnt = forcing_cnt + 1
!      this%EPHYTO1_col_frac_id = forcing_cnt
!
!      ! Net UV inhibition - Cullen et al. (1994)
!      forcing_cnt = forcing_cnt + 1
!      this%EPHYTO1_NET_col_frac_id = forcing_cnt


      ! UV inhibition - Cullen et al. (1992)
      forcing_cnt = forcing_cnt + 1
      this%EPHYTO1UVA_col_frac_id = forcing_cnt
      ! Net UV inhibition
      forcing_cnt = forcing_cnt + 1
      this%EPHYTO1UVA_NET_col_frac_id = forcing_cnt
      forcing_cnt = forcing_cnt + 1
      this%EPHYTO1UVB_col_frac_id = forcing_cnt
      forcing_cnt = forcing_cnt + 1
      this%EPHYTO1UVB_NET_col_frac_id = forcing_cnt
      forcing_cnt = forcing_cnt + 1
      this%EPHYTO1UVC_col_frac_id = forcing_cnt
      forcing_cnt = forcing_cnt + 1
      this%EPHYTO1UVC_NET_col_frac_id = forcing_cnt
      ! UV inhibition - Boucher et al. (1994)
      !forcing_cnt = forcing_cnt + 1
      !this%EPHYTO3_col_frac_id = forcing_cnt !ephyto3

!      ! UV inhibition - NEale and Thomas (2017)
!      forcing_cnt = forcing_cnt + 1
!      this%EPHYTO4_col_frac_id = forcing_cnt
!
!      ! UV inhibition - NEale and Thomas (2017)
!      forcing_cnt = forcing_cnt + 1
!      this%EPHYTO4_NET_col_frac_id = forcing_cnt
!
!      ! UV inhibition - Lorenzo et al. (2019)
!      forcing_cnt = forcing_cnt + 1
!      this%EPHYTO5_col_frac_id = forcing_cnt
!
!
!      ! UV inhibition - Lorenzo et al. (2019)
!      forcing_cnt = forcing_cnt + 1
!      this%EPHYTO5_NET_col_frac_id = forcing_cnt


      ! UV inhibition - Neale and Thomas (2017) Prochlorococcus small phytoplankton ephyto4
      forcing_cnt = forcing_cnt + 1
      this%EPHYTO4UVA_col_frac_id = forcing_cnt
      forcing_cnt = forcing_cnt + 1
      this%EPHYTO4UVA_NET_col_frac_id = forcing_cnt
      forcing_cnt = forcing_cnt + 1
      this%EPHYTO4UVB_col_frac_id = forcing_cnt
      forcing_cnt = forcing_cnt + 1
      this%EPHYTO4UVB_NET_col_frac_id = forcing_cnt
      forcing_cnt = forcing_cnt + 1
      this%EPHYTO4UVC_col_frac_id = forcing_cnt
      forcing_cnt = forcing_cnt + 1
      this%EPHYTO4UVC_NET_col_frac_id = forcing_cnt

      ! UV inhibition - Lorenzo et al 2019 emiliana huxleyi coccolithophores
      forcing_cnt = forcing_cnt + 1
      this%EPHYTO5UVA_col_frac_id = forcing_cnt
      forcing_cnt = forcing_cnt + 1
      this%EPHYTO5UVA_NET_col_frac_id = forcing_cnt
      forcing_cnt = forcing_cnt + 1
      this%EPHYTO5UVB_col_frac_id = forcing_cnt
      forcing_cnt = forcing_cnt + 1
      this%EPHYTO5UVB_NET_col_frac_id = forcing_cnt
      forcing_cnt = forcing_cnt + 1
      this%EPHYTO5UVC_col_frac_id = forcing_cnt
      forcing_cnt = forcing_cnt + 1
      this%EPHYTO5UVC_NET_col_frac_id = forcing_cnt

      ! UV inhibition - Guan and Gao 2010 emiliania Huxley coccolithophores

      ! UV inhibition - Neale and Thomas 2017 synechococcus small phytoplankton
      forcing_cnt = forcing_cnt + 1
      this%EPHYTO7UVA_col_frac_id = forcing_cnt
      forcing_cnt = forcing_cnt + 1
      this%EPHYTO7UVA_NET_col_frac_id = forcing_cnt
      forcing_cnt = forcing_cnt + 1
      this%EPHYTO7UVB_col_frac_id = forcing_cnt
      forcing_cnt = forcing_cnt + 1
      this%EPHYTO7UVB_NET_col_frac_id = forcing_cnt
      forcing_cnt = forcing_cnt + 1
      this%EPHYTO7UVC_col_frac_id = forcing_cnt
      forcing_cnt = forcing_cnt + 1
      this%EPHYTO7UVC_NET_col_frac_id = forcing_cnt
