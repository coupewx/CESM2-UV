module ocn_import_export
   ...
   use forcing_fields,    only: ATM_PAR
   use forcing_fields,    only: ATM_EPHYTO1UVA,ATM_EPHYTO1UVA_NET, ATM_EPHYTO1UVB,ATM_EPHYTO1UVB_NET, ATM_EPHYTO1UVC,ATM_EPHYTO1UVC_NET
   use forcing_fields,    only: ATM_EPHYTO4UVA,ATM_EPHYTO4UVA_NET, ATM_EPHYTO4UVB,ATM_EPHYTO4UVB_NET, ATM_EPHYTO4UVC,ATM_EPHYTO4UVC_NET
   use forcing_fields,    only: ATM_EPHYTO5UVA,ATM_EPHYTO5UVA_NET, ATM_EPHYTO5UVB,ATM_EPHYTO5UVB_NET, ATM_EPHYTO5UVC,ATM_EPHYTO5UVC_NET
   use forcing_fields,    only: ATM_EPHYTO7UVA,ATM_EPHYTO7UVA_NET, ATM_EPHYTO7UVB,ATM_EPHYTO7UVB_NET, ATM_EPHYTO7UVC,ATM_EPHYTO7UVC_NET
...
!-----------------------------------------------------------------------
      ...
      do i=this_block%ib,this_block%ie
         ...
         if (index_x2o_Sa_ephyto1UVA > 0) then
            ATM_EPHYTO1UVA(i,j,iblock) = x2o(index_x2o_Sa_ephyto1UVA,n) ! original - does not consider albedo
         end if
         if (index_x2o_Sa_ephyto1UVA_net > 0) then
            ATM_EPHYTO1UVA_NET(i,j,iblock) = x2o(index_x2o_Sa_ephyto1UVA_net,n) ! replaced ephyto1 with ephyto1_net
         end if
         if (index_x2o_Sa_ephyto1UVB > 0) then
            ATM_EPHYTO1UVB(i,j,iblock) = x2o(index_x2o_Sa_ephyto1UVB,n) ! original - does not consider albedo
         end if
         if (index_x2o_Sa_ephyto1UVB_net > 0) then
            ATM_EPHYTO1UVB_NET(i,j,iblock) = x2o(index_x2o_Sa_ephyto1UVB_net,n) ! replaced ephyto1 with ephyto1_net
         end if
         if (index_x2o_Sa_ephyto1UVC > 0) then
            ATM_EPHYTO1UVC(i,j,iblock) = x2o(index_x2o_Sa_ephyto1UVC,n) ! original - does not consider albedo
         end if
         if (index_x2o_Sa_ephyto1UVC_net > 0) then
            ATM_EPHYTO1UVC_NET(i,j,iblock) = x2o(index_x2o_Sa_ephyto1UVC_net,n) ! replaced ephyto1 with ephyto1_net
         end if


         if (index_x2o_Sa_ephyto4UVA > 0) then
            ATM_EPHYTO4UVA(i,j,iblock) = x2o(index_x2o_Sa_ephyto4UVA,n) ! original - does not consider albedo
         end if
         if (index_x2o_Sa_ephyto4UVA_net > 0) then
            ATM_EPHYTO4UVA_NET(i,j,iblock) = x2o(index_x2o_Sa_ephyto4UVA_net,n) ! replaced ephyto1 with ephyto1_net
         end if
         if (index_x2o_Sa_ephyto4UVB > 0) then
            ATM_EPHYTO4UVB(i,j,iblock) = x2o(index_x2o_Sa_ephyto4UVB,n) ! original - does not consider albedo
         end if
         if (index_x2o_Sa_ephyto4UVB_net > 0) then
            ATM_EPHYTO4UVB_NET(i,j,iblock) = x2o(index_x2o_Sa_ephyto4UVB_net,n) ! replaced ephyto1 with ephyto1_net
         end if
         if (index_x2o_Sa_ephyto4UVC > 0) then
            ATM_EPHYTO4UVC(i,j,iblock) = x2o(index_x2o_Sa_ephyto4UVC,n) ! original - does not consider albedo
         end if
         if (index_x2o_Sa_ephyto4UVC_net > 0) then
            ATM_EPHYTO4UVC_NET(i,j,iblock) = x2o(index_x2o_Sa_ephyto4UVC_net,n) ! replaced ephyto1 with ephyto1_net
         end if

         if (index_x2o_Sa_ephyto5UVA > 0) then
            ATM_EPHYTO5UVA(i,j,iblock) = x2o(index_x2o_Sa_ephyto5UVA,n) ! original - does not consider albedo
         end if
         if (index_x2o_Sa_ephyto5UVA_net > 0) then
            ATM_EPHYTO5UVA_NET(i,j,iblock) = x2o(index_x2o_Sa_ephyto5UVA_net,n) ! replaced ephyto1 with ephyto1_net
         end if
         if (index_x2o_Sa_ephyto5UVB > 0) then
            ATM_EPHYTO5UVB(i,j,iblock) = x2o(index_x2o_Sa_ephyto5UVB,n) ! original - does not consider albedo
         end if
         if (index_x2o_Sa_ephyto5UVB_net > 0) then
            ATM_EPHYTO5UVB_NET(i,j,iblock) = x2o(index_x2o_Sa_ephyto5UVB_net,n) ! replaced ephyto1 with ephyto1_net
         end if
         if (index_x2o_Sa_ephyto5UVC > 0) then
            ATM_EPHYTO5UVC(i,j,iblock) = x2o(index_x2o_Sa_ephyto5UVC,n) ! original - does not consider albedo
         end if
         if (index_x2o_Sa_ephyto5UVC_net > 0) then
            ATM_EPHYTO5UVC_NET(i,j,iblock) = x2o(index_x2o_Sa_ephyto5UVC_net,n) ! replaced ephyto1 with ephyto1_net
         end if


         !if (index_x2o_Sa_ephyto6UVA > 0) then
         !   ATM_EPHYTO6UVA(i,j,iblock) = x2o(index_x2o_Sa_ephyto6UVA,n) ! original - does not consider albedo
         !end if
         !if (index_x2o_Sa_ephyto6UVA_net > 0) then
         !   ATM_EPHYTO6UVA_NET(i,j,iblock) = x2o(index_x2o_Sa_ephyto6UVA_net,n) ! replaced ephyto1 with ephyto1_net
         !end if
         !if (index_x2o_Sa_ephyto6UVB > 0) then
         !   ATM_EPHYTO6UVB(i,j,iblock) = x2o(index_x2o_Sa_ephyto6UVB,n) ! original - does not consider albedo
         !end if
         !if (index_x2o_Sa_ephyto6UVB_net > 0) then
         !   ATM_EPHYTO6UVB_NET(i,j,iblock) = x2o(index_x2o_Sa_ephyto6UVB_net,n) ! replaced ephyto1 with ephyto1_net
         !end if
         !if (index_x2o_Sa_ephyto6UVC > 0) then
         !   ATM_EPHYTO6UVC(i,j,iblock) = x2o(index_x2o_Sa_ephyto6UVC,n) ! original - does not consider albedo
         !end if
         !if (index_x2o_Sa_ephyto6UVC_net > 0) then
         !   ATM_EPHYTO6UVC_NET(i,j,iblock) = x2o(index_x2o_Sa_ephyto6UVC_net,n) ! replaced ephyto1 with ephyto1_net
         !end if


         if (index_x2o_Sa_ephyto7UVA > 0) then
            ATM_EPHYTO7UVA(i,j,iblock) = x2o(index_x2o_Sa_ephyto7UVA,n) ! original - does not consider albedo
         end if
         if (index_x2o_Sa_ephyto7UVA_net > 0) then
            ATM_EPHYTO7UVA_NET(i,j,iblock) = x2o(index_x2o_Sa_ephyto7UVA_net,n) ! replaced ephyto1 with ephyto1_net
         end if
         if (index_x2o_Sa_ephyto7UVB > 0) then
            ATM_EPHYTO7UVB(i,j,iblock) = x2o(index_x2o_Sa_ephyto7UVB,n) ! original - does not consider albedo
         end if
         if (index_x2o_Sa_ephyto7UVB_net > 0) then
            ATM_EPHYTO7UVB_NET(i,j,iblock) = x2o(index_x2o_Sa_ephyto7UVB_net,n) ! replaced ephyto1 with ephyto1_net
         end if
         if (index_x2o_Sa_ephyto7UVC > 0) then
            ATM_EPHYTO7UVC(i,j,iblock) = x2o(index_x2o_Sa_ephyto7UVC,n) ! original - does not consider albedo
         end if
         if (index_x2o_Sa_ephyto7UVC_net > 0) then
            ATM_EPHYTO7UVC_NET(i,j,iblock) = x2o(index_x2o_Sa_ephyto7UVC_net,n) ! replaced ephyto1 with ephyto1_net
         end if
