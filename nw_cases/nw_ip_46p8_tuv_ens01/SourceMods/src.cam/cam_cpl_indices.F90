module cam_cpl_indices
  ...
  integer :: index_a2x_Faxa_uva        ! UVA radiation 
  integer :: index_a2x_Faxa_uvb        ! UVB radiation 
  integer :: index_a2x_Faxa_uvc
  integer :: index_a2x_Faxa_par        ! photosynthetic active radiation
  !integer :: index_a2x_Faxa_par_fake        ! photosynthetic active radiation (fake!) 
  !integer :: index_a2x_Sa_ephyto1    ! Photoinhibition, Phytoplankton 1  
  !integer :: index_a2x_Sa_ephyto2    ! Photoinhibition, Phytoplankton 2  
  !integer :: index_a2x_Sa_ephyto3    ! Photoinhibition, Phytoplankton 3  
  !integer :: index_a2x_Sa_ephyto4    ! Photoinhibition, Phytoplankton 4 - Neale and Thomas (2017)
  !integer :: index_a2x_Sa_ephyto5    ! Photoinhibition, Coccolithophores - Lorenzo et al. (2019)
  integer :: index_a2x_Sa_ephyto1UVA ! Photoinhibition, Cullen et al. (1992) Diatoms -  - Phaeodactylum sp. using E model
  integer :: index_a2x_Sa_ephyto1UVB
  integer :: index_a2x_Sa_ephyto1UVC
  integer :: index_a2x_Sa_ephyto4UVA  ! Photoinhibition, Neale and Thomas (2017) Small Phytoplankton - Prochlorococcus using Emax model (thresholds reported in paper)
  integer :: index_a2x_Sa_ephyto4UVB
  integer :: index_a2x_Sa_ephyto4UVC
  integer :: index_a2x_Sa_ephyto5UVA  ! Photoinhibition, Lorenzo et al. (2019) Coccolithophores - Emiliania huxleyi using T model
  integer :: index_a2x_Sa_ephyto5UVB
  integer :: index_a2x_Sa_ephyto5UVC
  !integer :: index_a2x_Sa_ephyto6UVA  ! Photoinhibition, Guan and Gao (2009) Coccolithophores - Emiliania huxleyi using E model
  !integer :: index_a2x_Sa_ephyto6UVB
  !integer :: index_a2x_Sa_ephyto6UVC
  integer :: index_a2x_Sa_ephyto7UVA  ! Photoinhibition, Neale and Thomas (2017) for Small Phytoplankton - Synechococcus using Emax model 
  integer :: index_a2x_Sa_ephyto7UVB
  integer :: index_a2x_Sa_ephyto7UVC
  integer :: index_a2x_Sa_plant71 
...
contains
  ...
  subroutine cam_cpl_indices_set( )
    ...
    index_a2x_Faxa_uva      = mct_avect_indexra(a2x,'Faxa_uva')
    index_a2x_Faxa_uvb      = mct_avect_indexra(a2x,'Faxa_uvb')
    index_a2x_Faxa_uvc      = mct_avect_indexra(a2x,'Faxa_uvc')
    index_a2x_Faxa_par      = mct_avect_indexra(a2x,'Faxa_par')
    !index_a2x_Faxa_par_fake = mct_avect_indexra(a2x,'Faxa_par_fake')
    !index_a2x_Sa_ephyto1    = mct_avect_indexra(a2x,'Sa_ephyto1')
    !index_a2x_Sa_ephyto2    = mct_avect_indexra(a2x,'Sa_ephyto2')
    !index_a2x_Sa_ephyto3    = mct_avect_indexra(a2x,'Sa_ephyto3')
    !index_a2x_Sa_ephyto4    = mct_avect_indexra(a2x,'Sa_ephyto4')
    !index_a2x_Sa_ephyto5    = mct_avect_indexra(a2x,'Sa_ephyto5')
 
    index_a2x_Sa_ephyto1UVA    = mct_avect_indexra(a2x,'Sa_ephyto1UVA')
    index_a2x_Sa_ephyto1UVB    = mct_avect_indexra(a2x,'Sa_ephyto1UVB')
    index_a2x_Sa_ephyto1UVC    = mct_avect_indexra(a2x,'Sa_ephyto1UVC')

    index_a2x_Sa_ephyto4UVA    = mct_avect_indexra(a2x,'Sa_ephyto4UVA')
    index_a2x_Sa_ephyto4UVB    = mct_avect_indexra(a2x,'Sa_ephyto4UVB')
    index_a2x_Sa_ephyto4UVC    = mct_avect_indexra(a2x,'Sa_ephyto4UVC')
    
    index_a2x_Sa_ephyto5UVA    = mct_avect_indexra(a2x,'Sa_ephyto5UVA')
    index_a2x_Sa_ephyto5UVB    = mct_avect_indexra(a2x,'Sa_ephyto5UVB')
    index_a2x_Sa_ephyto5UVC    = mct_avect_indexra(a2x,'Sa_ephyto5UVC')

    !index_a2x_Sa_ephyto6UVA    = mct_avect_indexra(a2x,'Sa_ephyto6UVA')
    !index_a2x_Sa_ephyto6UVB    = mct_avect_indexra(a2x,'Sa_ephyto6UVB')
    !index_a2x_Sa_ephyto6UVC    = mct_avect_indexra(a2x,'Sa_ephyto6UVC')

    index_a2x_Sa_ephyto7UVA    = mct_avect_indexra(a2x,'Sa_ephyto7UVA')
    index_a2x_Sa_ephyto7UVB    = mct_avect_indexra(a2x,'Sa_ephyto7UVB')
    index_a2x_Sa_ephyto7UVC    = mct_avect_indexra(a2x,'Sa_ephyto7UVC')

    index_a2x_Sa_plant71 = mct_avect_indexra(a2x,'Sa_plant71')
