...
module carma_model_flags_mod
  ...
  ! add specific info for india-pakistan targeting code
  character(len=256), public     :: carma_emis_file           = 'targetlist.nc'   ! name of the emission file
contains
  ...
  subroutine carma_model_readnl(nlfile)
    ...
    namelist /carma_model_nl/ &
      ...
      carma_emis_fire_fine_frac, carma_emis_fire_land_only, carma_emis_fire_veg_scale,carma_emis_file
