...
module carma_enums_mod
  ...
  integer, public, parameter :: I_VAPRTN_NONE              = 5   !! Stub for gas that doesn't need vaporp
  ...
  integer, public, parameter :: I_GCOMP_SO2             = 3   !! Sulfur Dioxide
  integer, public, parameter :: I_GCOMP_CO2             = 4   !! Carbon Dioxide
  integer, public, parameter :: I_GCOMP_HBR             = 5   !! Hydrobromic Acid
  integer, public, parameter :: I_GCOMP_HCL             = 6   !! Hyrdochloric Acid
  integer, public, parameter :: I_GCOMP_NO              = 7   !! Nitric Oxide
  integer, public, parameter :: I_GCOMP_O3              = 8   !! Ozone
  integer, public, parameter :: I_GCOMP_OH              = 9   !! Hydroxl
