...
contains
  ...
  subroutine seq_flds_set(nmlfile, ID, infodata)
    ...
    ! UVA radiation
    call seq_flds_add(a2x_fluxes,"Faxa_uva" )
    call seq_flds_add(x2i_fluxes,"Faxa_uva" )
    call seq_flds_add(x2l_fluxes,"Faxa_uva" )
    call seq_flds_add(x2o_fluxes,"Faxa_uva" )
    longname = 'UVA radiation'
    stdname  = 'uva_raditation'
    units    = 'W m-2'
    attname  = 'Faxa_uva'
    call metadata_set(attname, longname, stdname, units)

    ! UV radiation
    call seq_flds_add(a2x_fluxes,"Faxa_uvb" )
    call seq_flds_add(x2i_fluxes,"Faxa_uvb" )
    call seq_flds_add(x2l_fluxes,"Faxa_uvb" )
    call seq_flds_add(x2o_fluxes,"Faxa_uvb" )
    longname = 'UVB radiation'
    stdname  = 'uvb_raditation'
    units    = 'W m-2'
    attname  = 'Faxa_uvb'
    call metadata_set(attname, longname, stdname, units)

    call seq_flds_add(a2x_fluxes,"Faxa_uvc" )
    call seq_flds_add(x2i_fluxes,"Faxa_uvc" )
    call seq_flds_add(x2l_fluxes,"Faxa_uvc" )
    call seq_flds_add(x2o_fluxes,"Faxa_uvc" )
    longname = 'UVC radiation'
    stdname  = 'uvc_raditation'
    units    = 'W m-2'
    attname  = 'Faxa_uvc'
    call metadata_set(attname, longname, stdname, units)

    ! Photosynthetic active radiation
    call seq_flds_add(a2x_fluxes,"Faxa_par" )
    call seq_flds_add(x2i_fluxes,"Faxa_par" )
    call seq_flds_add(x2l_fluxes,"Faxa_par" )
    call seq_flds_add(x2o_fluxes,"Faxa_par" )
    longname = 'Photosynthetic active radiation'
    stdname  = 'photosynthetic_active_raditation'
    units    = 'W m-2'
    attname  = 'Faxa_par'
    call metadata_set(attname, longname, stdname, units)

    ! Photosynthetic active radiation (fake)
    !call seq_flds_add(a2x_fluxes,"Faxa_par_fake" )
    !call seq_flds_add(x2i_fluxes,"Faxa_par_fake" )
    !call seq_flds_add(x2l_fluxes,"Faxa_par_fake" )
    !call seq_flds_add(x2o_fluxes,"Faxa_par_fake" )
    !longname = 'Fake Photosynthetic active radiation'
    !stdname  = 'fake_photosynthetic_active_raditation'
    !units    = 'W m-2'
    !attname  = 'Faxa_par_fake'
    !call metadata_set(attname, longname, stdname, units)


    ! Phytoplankton Photoinhibition, Phaeadactylum (Cullen, 1992)
    call seq_flds_add(a2x_states,"Sa_ephyto1UVA" )
    call seq_flds_add(x2i_states,"Sa_ephyto1UVA" )
    call seq_flds_add(x2l_states,"Sa_ephyto1UVA" )
    call seq_flds_add(x2o_states,"Sa_ephyto1UVA" )
    longname = 'Phytoplankton photoinhibition UVA, Phaeodactylum'
    stdname  = 'phtytoplankton_photoinhibition_phaeodactylum_UVA'
    units    = '1'
    attname  = 'Sa_ephyto1UVA'
    call metadata_set(attname, longname, stdname, units)

    ! Phytoplankton Photoinhibition, Phaeadactylum (Cullen, 1992)
    call seq_flds_add(a2x_states,"Sa_ephyto1UVA_net" )
    call seq_flds_add(x2i_states,"Sa_ephyto1UVA_net" )
    call seq_flds_add(x2l_states,"Sa_ephyto1UVA_net" )
    call seq_flds_add(x2o_states,"Sa_ephyto1UVA_net" )
    longname = 'Phytoplankton photoinhibition UVA, Phaeodactylum'
    stdname  = 'phtytoplankton_photoinhibition_phaeodactylum_UVA'
    units    = '1'
    attname  = 'Sa_ephyto1UVA_net'
    call metadata_set(attname, longname, stdname, units)

    call seq_flds_add(a2x_states,"Sa_ephyto1UVB" )
    call seq_flds_add(x2i_states,"Sa_ephyto1UVB" )
    call seq_flds_add(x2l_states,"Sa_ephyto1UVB" )
    call seq_flds_add(x2o_states,"Sa_ephyto1UVB" )
    longname = 'Phytoplankton photoinhibition UVB, Phaeodactylum'
    stdname  = 'phtytoplankton_photoinhibition_phaeodactylum_UVB'
    units    = '1'
    attname  = 'Sa_ephyto1UVB'
    call metadata_set(attname, longname, stdname, units)

    ! Phytoplankton Photoinhibition, Phaeadactylum (Cullen, 1992)
    call seq_flds_add(a2x_states,"Sa_ephyto1UVB_net" )
    call seq_flds_add(x2i_states,"Sa_ephyto1UVB_net" )
    call seq_flds_add(x2l_states,"Sa_ephyto1UVB_net" )
    call seq_flds_add(x2o_states,"Sa_ephyto1UVB_net" )
    longname = 'Phytoplankton photoinhibition UVB, Phaeodactylum'
    stdname  = 'phtytoplankton_photoinhibition_phaeodactylum_UVB'
    units    = '1'
    attname  = 'Sa_ephyto1UVB_net'
    call metadata_set(attname, longname, stdname, units)

    call seq_flds_add(a2x_states,"Sa_ephyto1UVC" )
    call seq_flds_add(x2i_states,"Sa_ephyto1UVC" )
    call seq_flds_add(x2l_states,"Sa_ephyto1UVC" )
    call seq_flds_add(x2o_states,"Sa_ephyto1UVC" )
    longname = 'Phytoplankton photoinhibition UVC, Phaeodactylum'
    stdname  = 'phtytoplankton_photoinhibition_phaeodactylum_UVC'
    units    = '1'
    attname  = 'Sa_ephyto1UVC'
    call metadata_set(attname, longname, stdname, units)

    ! Phytoplankton Photoinhibition, Phaeadactylum (Cullen, 1992)
    call seq_flds_add(a2x_states,"Sa_ephyto1UVC_net" )
    call seq_flds_add(x2i_states,"Sa_ephyto1UVC_net" )
    call seq_flds_add(x2l_states,"Sa_ephyto1UVC_net" )
    call seq_flds_add(x2o_states,"Sa_ephyto1UVC_net" )
    longname = 'Phytoplankton photoinhibition UVC, Phaeodactylum'
    stdname  = 'phtytoplankton_photoinhibition_phaeodactylum_UVC'
    units    = '1'
    attname  = 'Sa_ephyto1UVC_net'
    call metadata_set(attname, longname, stdname, units)


    ! Phytoplankton Photoinhibition, Prorocentrum (Cullen, 1992)
    !call seq_flds_add(a2x_states,"Sa_ephyto2" )
    !call seq_flds_add(x2i_states,"Sa_ephyto2" )
    !call seq_flds_add(x2l_states,"Sa_ephyto2" )
    !call seq_flds_add(x2o_states,"Sa_ephyto2" )
    !longname = 'Phytoplankton photoinhibition, Prorocebtrum'
    !stdname  = 'phtytoplankton_photoinhibition_prorcentrum'
    !units    = '1'
    !attname  = 'Sa_ephyto2'
    !call metadata_set(attname, longname, stdname, units)

    ! Phytoplankton Photoinhibition, Prorocentrum (Boucher, 1992)
    !call seq_flds_add(a2x_states,"Sa_ephyto3" )
    !call seq_flds_add(x2i_states,"Sa_ephyto3" )
    !call seq_flds_add(x2l_states,"Sa_ephyto3" )
    !call seq_flds_add(x2o_states,"Sa_ephyto3" )
    !longname = 'Phytoplankton photoinhibition, Boucher'
    !stdname  = 'phtytoplankton_photoinhibition_boucher'
    !units    = '1'
    !attname  = 'Sa_ephyto3'
    !call metadata_set(attname, longname, stdname, units)

    ! Phytoplankton Photoinhibition, Prochlorococcus (Neale and Thomas, 2017))
    call seq_flds_add(a2x_states,"Sa_ephyto4UVA" )
    call seq_flds_add(x2i_states,"Sa_ephyto4UVA" )
    call seq_flds_add(x2l_states,"Sa_ephyto4UVA" )
    call seq_flds_add(x2o_states,"Sa_ephyto4UVA" )
    longname = 'Phytoplankton photoinhibition UVA, Neale and Thomas'
    stdname  = 'phtytoplankton_photoinhibition_neale_UVA'
    units    = '1'
    attname  = 'Sa_ephyto4UVA'
    call metadata_set(attname, longname, stdname, units)

    call seq_flds_add(a2x_states,"Sa_ephyto4UVB" )
    call seq_flds_add(x2i_states,"Sa_ephyto4UVB" )
    call seq_flds_add(x2l_states,"Sa_ephyto4UVB" )
    call seq_flds_add(x2o_states,"Sa_ephyto4UVB" )
    longname = 'Phytoplankton photoinhibition UVB, Neale and Thomas'
    stdname  = 'phtytoplankton_photoinhibition_neale_UVB'
    units    = '1'
    attname  = 'Sa_ephyto4UVB'
    call metadata_set(attname, longname, stdname, units)

    call seq_flds_add(a2x_states,"Sa_ephyto4UVC" )
    call seq_flds_add(x2i_states,"Sa_ephyto4UVC" )
    call seq_flds_add(x2l_states,"Sa_ephyto4UVC" )
    call seq_flds_add(x2o_states,"Sa_ephyto4UVC" )
    longname = 'Phytoplankton photoinhibition UVC, Neale and Thomas'
    stdname  = 'phtytoplankton_photoinhibition_neale_UVC'
    units    = '1'
    attname  = 'Sa_ephyto4UVC'
    call metadata_set(attname, longname, stdname, units)

    ! Phytoplankton Photoinhibition, emliana huxleyi (Lorenzo et al., 2019)
    call seq_flds_add(a2x_states,"Sa_ephyto5UVA" )
    call seq_flds_add(x2i_states,"Sa_ephyto5UVA" )
    call seq_flds_add(x2l_states,"Sa_ephyto5UVA" )
    call seq_flds_add(x2o_states,"Sa_ephyto5UVA" )
    longname = 'Phytoplankton photoinhibition UVA, Lorenzo'
    stdname  = 'phtytoplankton_photoinhibition_lorenzo_UVA'
    units    = '1'
    attname  = 'Sa_ephyto5UVA'
    call metadata_set(attname, longname, stdname, units)

    call seq_flds_add(a2x_states,"Sa_ephyto5UVB" )
    call seq_flds_add(x2i_states,"Sa_ephyto5UVB" )
    call seq_flds_add(x2l_states,"Sa_ephyto5UVB" )
    call seq_flds_add(x2o_states,"Sa_ephyto5UVB" )
    longname = 'Phytoplankton photoinhibition UVB, Lorenzo'
    stdname  = 'phtytoplankton_photoinhibition_lorenzo_UVB'
    units    = '1'
    attname  = 'Sa_ephyto5UVB'
    call metadata_set(attname, longname, stdname, units)

    call seq_flds_add(a2x_states,"Sa_ephyto5UVC" )
    call seq_flds_add(x2i_states,"Sa_ephyto5UVC" )
    call seq_flds_add(x2l_states,"Sa_ephyto5UVC" )
    call seq_flds_add(x2o_states,"Sa_ephyto5UVC" )
    longname = 'Phytoplankton photoinhibition UVC, Lorenzo'
    stdname  = 'phtytoplankton_photoinhibition_lorenzo_UVC'
    units    = '1'
    attname  = 'Sa_ephyto5UVC'
    call metadata_set(attname, longname, stdname, units)



    call seq_flds_add(a2x_states,"Sa_ephyto4UVA_net" )
    call seq_flds_add(x2i_states,"Sa_ephyto4UVA_net" )
    call seq_flds_add(x2l_states,"Sa_ephyto4UVA_net" )
    call seq_flds_add(x2o_states,"Sa_ephyto4UVA_net" )
    longname = 'Phytoplankton photoinhibition UVA, Neale and Thomas'
    stdname  = 'phtytoplankton_photoinhibition_neale_UVA'
    units    = '1'
    attname  = 'Sa_ephyto4UVA_net'
    call metadata_set(attname, longname, stdname, units)

    call seq_flds_add(a2x_states,"Sa_ephyto4UVB_net" )
    call seq_flds_add(x2i_states,"Sa_ephyto4UVB_net" )
    call seq_flds_add(x2l_states,"Sa_ephyto4UVB_net" )
    call seq_flds_add(x2o_states,"Sa_ephyto4UVB_net" )
    longname = 'Phytoplankton photoinhibition UVB, Neale and Thomas'
    stdname  = 'phtytoplankton_photoinhibition_neale_UVB'
    units    = '1'
    attname  = 'Sa_ephyto4UVB_net'
    call metadata_set(attname, longname, stdname, units)

    call seq_flds_add(a2x_states,"Sa_ephyto4UVC_net" )
    call seq_flds_add(x2i_states,"Sa_ephyto4UVC_net" )
    call seq_flds_add(x2l_states,"Sa_ephyto4UVC_net" )
    call seq_flds_add(x2o_states,"Sa_ephyto4UVC_net" )
    longname = 'Phytoplankton photoinhibition UVC, Neale and Thomas'
    stdname  = 'phtytoplankton_photoinhibition_neale_UVC'
    units    = '1'
    attname  = 'Sa_ephyto4UVC_net'
    call metadata_set(attname, longname, stdname, units)


    call seq_flds_add(a2x_states,"Sa_ephyto5UVA_net" )
    call seq_flds_add(x2i_states,"Sa_ephyto5UVA_net" )
    call seq_flds_add(x2l_states,"Sa_ephyto5UVA_net" )
    call seq_flds_add(x2o_states,"Sa_ephyto5UVA_net" )
    longname = 'Phytoplankton photoinhibition UVA, Lorenzo'
    stdname  = 'phtytoplankton_photoinhibition_lorenzo_UVA'
    units    = '1'
    attname  = 'Sa_ephyto5UVA_net'
    call metadata_set(attname, longname, stdname, units)

    call seq_flds_add(a2x_states,"Sa_ephyto5UVB_net" )
    call seq_flds_add(x2i_states,"Sa_ephyto5UVB_net" )
    call seq_flds_add(x2l_states,"Sa_ephyto5UVB_net" )
    call seq_flds_add(x2o_states,"Sa_ephyto5UVB_net" )
    longname = 'Phytoplankton photoinhibition UVB, Lorenzo'
    stdname  = 'phtytoplankton_photoinhibition_lorenzo_UVB'
    units    = '1'
    attname  = 'Sa_ephyto5UVB_net'
    call metadata_set(attname, longname, stdname, units)

    call seq_flds_add(a2x_states,"Sa_ephyto5UVC_net" )
    call seq_flds_add(x2i_states,"Sa_ephyto5UVC_net" )
    call seq_flds_add(x2l_states,"Sa_ephyto5UVC_net" )
    call seq_flds_add(x2o_states,"Sa_ephyto5UVC_net" )
    longname = 'Phytoplankton photoinhibition UVC, Lorenzo'
    stdname  = 'phtytoplankton_photoinhibition_lorenzo_UVC'
    units    = '1'
    attname  = 'Sa_ephyto5UVC_net'
    call metadata_set(attname, longname, stdname, units)


    !call seq_flds_add(a2x_states,"Sa_ephyto6UVA" )
    !call seq_flds_add(x2i_states,"Sa_ephyto6UVA" )
    !call seq_flds_add(x2l_states,"Sa_ephyto6UVA" )
    !call seq_flds_add(x2o_states,"Sa_ephyto6UVA" )
    !longname = 'Phytoplankton photoinhibition UVA, Guan'
    !stdname  = 'phytoplankton_photoinhibition_guan_UVA'
    !units    = '1'
    !attname  = 'Sa_ephyto6UVA'
    !call metadata_set(attname, longname, stdname, units)

    !call seq_flds_add(a2x_states,"Sa_ephyto6UVB" )
    !call seq_flds_add(x2i_states,"Sa_ephyto6UVB" )
    !call seq_flds_add(x2l_states,"Sa_ephyto6UVB" )
    !call seq_flds_add(x2o_states,"Sa_ephyto6UVB" )
    !longname = 'Phytoplankton photoinhibition UVB, Guan'
    !stdname  = 'phytoplankton_photoinhibition_guan_UVB'
    !units    = '1'
    !attname  = 'Sa_ephyto6UVB'
    !call metadata_set(attname, longname, stdname, units)

    !call seq_flds_add(a2x_states,"Sa_ephyto6UVC" )
    !call seq_flds_add(x2i_states,"Sa_ephyto6UVC" )
    !call seq_flds_add(x2l_states,"Sa_ephyto6UVC" )
    !call seq_flds_add(x2o_states,"Sa_ephyto6UVC" )
    !longname = 'Phytoplankton photoinhibition UVC, Lorenzo'
    !stdname  = 'phtytoplankton_photoinhibition_guan_UVC'
    !units    = '1'
    !attname  = 'Sa_ephyto6UVC'
    !call metadata_set(attname, longname, stdname, units)


    !call seq_flds_add(a2x_states,"Sa_ephyto6UVA_net" )
    !call seq_flds_add(x2i_states,"Sa_ephyto6UVA_net" )
    !call seq_flds_add(x2l_states,"Sa_ephyto6UVA_net" )
    !call seq_flds_add(x2o_states,"Sa_ephyto6UVA_net" )
    !longname = 'Phytoplankton photoinhibition UVA, Guan'
    !stdname  = 'phtytoplankton_photoinhibition_guan_UVA'
    !units    = '1'
    !attname  = 'Sa_ephyto6UVA_net'
    !call metadata_set(attname, longname, stdname, units)

    !call seq_flds_add(a2x_states,"Sa_ephyto6UVB_net" )
    !call seq_flds_add(x2i_states,"Sa_ephyto6UVB_net" )
    !call seq_flds_add(x2l_states,"Sa_ephyto6UVB_net" )
    !call seq_flds_add(x2o_states,"Sa_ephyto6UVB_net" )
    !longname = 'Phytoplankton photoinhibition UVB, Guan'
    !stdname  = 'phytoplankton_photoinhibition_guan_UVB'
    !units    = '1'
    !attname  = 'Sa_ephyto6UVB_net'
    !call metadata_set(attname, longname, stdname, units)

    !call seq_flds_add(a2x_states,"Sa_ephyto6UVC_net" )
    !call seq_flds_add(x2i_states,"Sa_ephyto6UVC_net" )
    !call seq_flds_add(x2l_states,"Sa_ephyto6UVC_net" )
    !call seq_flds_add(x2o_states,"Sa_ephyto6UVC_net" )
    !longname = 'Phytoplankton photoinhibition UVC, Lorenzo'
    !stdname  = 'phytoplankton_photoinhibition_guan_UVC'
    !units    = '1'
    !attname  = 'Sa_ephyto6UVC_net'
    !call metadata_set(attname, longname, stdname, units)

    call seq_flds_add(a2x_states,"Sa_ephyto7UVA" )
    call seq_flds_add(x2i_states,"Sa_ephyto7UVA" )
    call seq_flds_add(x2l_states,"Sa_ephyto7UVA" )
    call seq_flds_add(x2o_states,"Sa_ephyto7UVA" )
    longname = 'Phytoplankton photoinhibition UVA, Neale'
    stdname  = 'phytoplankton_photoinhibition_neale_UVA'
    units    = '1'
    attname  = 'Sa_ephyto7UVA'
    call metadata_set(attname, longname, stdname, units)

    call seq_flds_add(a2x_states,"Sa_ephyto7UVB" )
    call seq_flds_add(x2i_states,"Sa_ephyto7UVB" )
    call seq_flds_add(x2l_states,"Sa_ephyto7UVB" )
    call seq_flds_add(x2o_states,"Sa_ephyto7UVB" )
    longname = 'Phytoplankton photoinhibition UVB, Neale'
    stdname  = 'phytoplankton_photoinhibition_neale_UVB'
    units    = '1'
    attname  = 'Sa_ephyto7UVB'
    call metadata_set(attname, longname, stdname, units)

    call seq_flds_add(a2x_states,"Sa_ephyto7UVC" )
    call seq_flds_add(x2i_states,"Sa_ephyto7UVC" )
    call seq_flds_add(x2l_states,"Sa_ephyto7UVC" )
    call seq_flds_add(x2o_states,"Sa_ephyto7UVC" )
    longname = 'Phytoplankton photoinhibition UVC, Neale'
    stdname  = 'phtytoplankton_photoinhibition_neale_UVC'
    units    = '1'
    attname  = 'Sa_ephyto7UVC'
    call metadata_set(attname, longname, stdname, units)


    call seq_flds_add(a2x_states,"Sa_ephyto7UVA_net" )
    call seq_flds_add(x2i_states,"Sa_ephyto7UVA_net" )
    call seq_flds_add(x2l_states,"Sa_ephyto7UVA_net" )
    call seq_flds_add(x2o_states,"Sa_ephyto7UVA_net" )
    longname = 'Phytoplankton photoinhibition UVA, Neale'
    stdname  = 'phtytoplankton_photoinhibition_neale_UVA'
    units    = '1'
    attname  = 'Sa_ephyto7UVA_net'
    call metadata_set(attname, longname, stdname, units)

    call seq_flds_add(a2x_states,"Sa_ephyto7UVB_net" )
    call seq_flds_add(x2i_states,"Sa_ephyto7UVB_net" )
    call seq_flds_add(x2l_states,"Sa_ephyto7UVB_net" )
    call seq_flds_add(x2o_states,"Sa_ephyto7UVB_net" )
    longname = 'Phytoplankton photoinhibition UVB, Neale'
    stdname  = 'phytoplankton_photoinhibition_guan_UVB'
    units    = '1'
    attname  = 'Sa_ephyto7UVB_net'
    call metadata_set(attname, longname, stdname, units)

    call seq_flds_add(a2x_states,"Sa_ephyto7UVC_net" )
    call seq_flds_add(x2i_states,"Sa_ephyto7UVC_net" )
    call seq_flds_add(x2l_states,"Sa_ephyto7UVC_net" )
    call seq_flds_add(x2o_states,"Sa_ephyto7UVC_net" )
    longname = 'Phytoplankton photoinhibition UVC, Neale'
    stdname  = 'phytoplankton_photoinhibition_neale_UVC'
    units    = '1'
    attname  = 'Sa_ephyto7UVC_net'
    call metadata_set(attname, longname, stdname, units)


    call seq_flds_add(a2x_states,"Sa_plant71" )
    call seq_flds_add(x2i_states,"Sa_plant71" )
    call seq_flds_add(x2l_states,"Sa_plant71" )
    call seq_flds_add(x2o_states,"Sa_plant71" )
    longname = 'Plant inhibition, Caldwell'
    stdname='plant_inhibition_caldwell'
    units = '1'
    attname = 'Sa_plant71'
    call metadata_set(attname, longname, stdname, units)


!    ! Phytoplankton Photoinhibition, Prococchlocorucisu (Neale and Thomas, 2017))
!    call seq_flds_add(a2x_states,"Sa_ephyto4_net" )
!    call seq_flds_add(x2i_states,"Sa_ephyto4_net" )
!    call seq_flds_add(x2l_states,"Sa_ephyto4_net" )
!    call seq_flds_add(x2o_states,"Sa_ephyto4_net" )
!    longname = 'Phytoplankton photoinhibition, Neale and Thomas'
!    stdname  = 'phtytoplankton_photoinhibition_neale'
!    units    = '1'
!    attname  = 'Sa_ephyto4_net'
!    call metadata_set(attname, longname, stdname, units)

!    ! Phytoplankton Photoinhibition, emliana huxleyi (Lorenzo et al., 2019)
!    call seq_flds_add(a2x_states,"Sa_ephyto5_net" )
!    call seq_flds_add(x2i_states,"Sa_ephyto5_net" )
!    call seq_flds_add(x2l_states,"Sa_ephyto5_net" )
!    call seq_flds_add(x2o_states,"Sa_ephyto5_net" )
!    longname = 'Phytoplankton photoinhibition, Lorenzo'
!    stdname  = 'phtytoplankton_photoinhibition_lorenzo'
!    units    = '1'
!    attname  = 'Sa_ephyto5_net'
!    call metadata_set(attname, longname, stdname, units)
