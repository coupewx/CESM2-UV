...
!                       EPHYTO1_col_frac_id= 0, &  ! COUPE ADDED - CULLEN
!                       EPHYTO1_NET_col_frac_id=0,&
!                       EPHYTO4_col_frac_id=0, & ! coupe added -n eale and thomas 
!                       EPHYTO4_NET_col_frac_id=0,&
!                       EPHYTO5_col_frac_id=0,  &
!                       EPHYTO5_NET_col_frac_id=0,&
!                       potemp_ind         = 0, &
!                       salinity_ind       = 0, &
!                       pressure_ind       = 0, &
!                       fesedflux_ind      = 0
 integer(int_kind), public :: dustflux_ind       = 0, &
                       PAR_col_frac_ind   = 0, &
                       surf_shortwave_ind = 0, &
                       EPHYTO1UVA_col_frac_id= 0, &  
                       EPHYTO1UVA_NET_col_frac_id=0,&
                       EPHYTO1UVB_col_frac_id= 0, &  
                       EPHYTO1UVB_NET_col_frac_id=0,&
                       EPHYTO1UVC_col_frac_id= 0, &  
                       EPHYTO1UVC_NET_col_frac_id=0,&

                       EPHYTO4UVA_col_frac_id= 0, &  
                       EPHYTO4UVA_NET_col_frac_id=0,&
                       EPHYTO4UVB_col_frac_id= 0, &  
                       EPHYTO4UVB_NET_col_frac_id=0,&
                       EPHYTO4UVC_col_frac_id= 0, &  
                       EPHYTO4UVC_NET_col_frac_id=0,&

                       EPHYTO5UVA_col_frac_id= 0, &  
                       EPHYTO5UVA_NET_col_frac_id=0,&
                       EPHYTO5UVB_col_frac_id= 0, &  
                       EPHYTO5UVB_NET_col_frac_id=0,&
                       EPHYTO5UVC_col_frac_id= 0, &  
                       EPHYTO5UVC_NET_col_frac_id=0,&

                       EPHYTO7UVA_col_frac_id= 0, &  
                       EPHYTO7UVA_NET_col_frac_id=0,&
                       EPHYTO7UVB_col_frac_id= 0, &  
                       EPHYTO7UVB_NET_col_frac_id=0,&
                       EPHYTO7UVC_col_frac_id= 0, &  
                       EPHYTO7UVC_NET_col_frac_id=0,&
                       potemp_ind         = 0, &
                       salinity_ind       = 0, &
                       pressure_ind       = 0, &
                       fesedflux_ind      = 0
...
!           case ('UV Inhibition Phyto1') ! COUPE ADDED - CULLEN ET AL. (1992)
!            EPHYTO1_col_frac_id = n
!            call interior_tendency_forcings(n)%add_forcing_field(field_source='internal',  &
!                          marbl_varname=marbl_varname, field_units=units,               &
!                          driver_varname='atm_ephyto1', rank=2, id=n)

!            case ('Net UV Inhibition Phyto1') ! COUPE ADDED - CULLEN ET AL. (1992)
!            EPHYTO1_NET_col_frac_id = n
!            call interior_tendency_forcings(n)%add_forcing_field(field_source='internal',  &
!                          marbl_varname=marbl_varname, field_units=units,               &
!                          driver_varname='atm_ephyto1_net', rank=2, id=n)

           ! case ('UV Inhibition Phyto3') ! COUPE ADDED - BOUCHER ET AL. (1994)
           ! EPHYTO3_col_frac_id = n
           ! call interior_tendency_forcings(n)%add_forcing_field(field_source='internal',  &
           !               marbl_varname=marbl_varname, field_units=units,               &
           !               driver_varname='atm_ephyto3', rank=2, id=n)

           !!! EPHYTO1 UVA UVB UVC
           case ('Inhibition Phyto1UVA') ! COUPE ADDED - CULLEN ET AL. (1992)
            EPHYTO1UVA_col_frac_id = n
            call interior_tendency_forcings(n)%add_forcing_field(field_source='internal',  &
                          marbl_varname=marbl_varname, field_units=units,               &
                          driver_varname='atm_ephyto1UVA', rank=2, id=n)

            case ('Net Inhibition Phyto1UVA') ! COUPE ADDED - CULLEN ET AL. (1992)
            EPHYTO1UVA_NET_col_frac_id = n
            call interior_tendency_forcings(n)%add_forcing_field(field_source='internal',  &
                          marbl_varname=marbl_varname, field_units=units,               &
                          driver_varname='atm_ephyto1UVA_net', rank=2, id=n)


           case ('Inhibition Phyto1UVB') ! COUPE ADDED - CULLEN ET AL. (1992)
            EPHYTO1UVB_col_frac_id = n
            call interior_tendency_forcings(n)%add_forcing_field(field_source='internal',  &
                          marbl_varname=marbl_varname, field_units=units,               &
                          driver_varname='atm_ephyto1UVB', rank=2, id=n)

            case ('Net Inhibition Phyto1UVB') ! COUPE ADDED - CULLEN ET AL. (1992)
            EPHYTO1UVB_NET_col_frac_id = n
            call interior_tendency_forcings(n)%add_forcing_field(field_source='internal',  &
                          marbl_varname=marbl_varname, field_units=units,               &
                          driver_varname='atm_ephyto1UVB_net', rank=2, id=n)


           case ('Inhibition Phyto1UVC') ! COUPE ADDED - CULLEN ET AL. (1992)
            EPHYTO1UVC_col_frac_id = n
            call interior_tendency_forcings(n)%add_forcing_field(field_source='internal',  &
                          marbl_varname=marbl_varname, field_units=units,               &
                          driver_varname='atm_ephyto1UVC', rank=2, id=n)

            case ('Net Inhibition Phyto1UVC') ! COUPE ADDED - CULLEN ET AL. (1992)
            EPHYTO1UVC_NET_col_frac_id = n
            call interior_tendency_forcings(n)%add_forcing_field(field_source='internal',  &
                          marbl_varname=marbl_varname, field_units=units,               &
                          driver_varname='atm_ephyto1UVC_net', rank=2, id=n)


           !!!! NEALE AND THOMAS 2017 PROCHLOROCOCCUS 
          
           case ('Inhibition Phyto4UVA') 
            EPHYTO4UVA_col_frac_id = n
            call interior_tendency_forcings(n)%add_forcing_field(field_source='internal',  &
                          marbl_varname=marbl_varname, field_units=units,               &
                          driver_varname='atm_ephyto4UVA', rank=2, id=n)

            case ('Net Inhibition Phyto4UVA') 
            EPHYTO4UVA_NET_col_frac_id = n
            call interior_tendency_forcings(n)%add_forcing_field(field_source='internal',  &
                          marbl_varname=marbl_varname, field_units=units,               &
                          driver_varname='atm_ephyto4UVA_net', rank=2, id=n)


           case ('Inhibition Phyto4UVB') 
            EPHYTO4UVB_col_frac_id = n
            call interior_tendency_forcings(n)%add_forcing_field(field_source='internal',  &
                          marbl_varname=marbl_varname, field_units=units,               &
                          driver_varname='atm_ephyto4UVB', rank=2, id=n)

            case ('Net Inhibition Phyto4UVB') 
            EPHYTO4UVB_NET_col_frac_id = n
            call interior_tendency_forcings(n)%add_forcing_field(field_source='internal',  &
                          marbl_varname=marbl_varname, field_units=units,               &
                          driver_varname='atm_ephyto4UVB_net', rank=2, id=n)


           case ('Inhibition Phyto4UVC') 
            EPHYTO4UVC_col_frac_id = n
            call interior_tendency_forcings(n)%add_forcing_field(field_source='internal',  &
                          marbl_varname=marbl_varname, field_units=units,               &
                          driver_varname='atm_ephyto4UVC', rank=2, id=n)

            case ('Net Inhibition Phyto4UVC') 
            EPHYTO4UVC_NET_col_frac_id = n
            call interior_tendency_forcings(n)%add_forcing_field(field_source='internal',  &
                          marbl_varname=marbl_varname, field_units=units,               &
                          driver_varname='atm_ephyto4UVC_net', rank=2, id=n)
           
           
           
           ! case ('UV Inhibition Phyto4') ! COUPE ADDED - NEALE AND THOMAS 2017 
          !  EPHYTO4_col_frac_id = n
          !  call interior_tendency_forcings(n)%add_forcing_field(field_source='internal',  &
          !                marbl_varname=marbl_varname, field_units=units,               &
         !                 driver_varname='atm_ephyto4', rank=2, id=n)

          ! case ('Net UV Inhibition Phyto4') ! COUPE ADDED - NEALE AND THOMAS 2017 
          !  EPHYTO4_NET_col_frac_id = n
          !  call interior_tendency_forcings(n)%add_forcing_field(field_source='internal',  &
          !                marbl_varname=marbl_varname, field_units=units,               &
          !                driver_varname='atm_ephyto4_net', rank=2, id=n)



          ! LORENZO ET AL. 2019 COCCOLITHOPHORES 
            case ('Inhibition Phyto5UVA')
            EPHYTO5UVA_col_frac_id = n
            call interior_tendency_forcings(n)%add_forcing_field(field_source='internal',  &
                          marbl_varname=marbl_varname, field_units=units,               &
                          driver_varname='atm_ephyto5UVA', rank=2, id=n)

            case ('Net Inhibition Phyto5UVA')
            EPHYTO5UVA_NET_col_frac_id = n
            call interior_tendency_forcings(n)%add_forcing_field(field_source='internal',  &
                          marbl_varname=marbl_varname, field_units=units,               &
                          driver_varname='atm_ephyto5UVA_net', rank=2, id=n)


           case ('Inhibition Phyto5UVB')
            EPHYTO5UVB_col_frac_id = n
            call interior_tendency_forcings(n)%add_forcing_field(field_source='internal',  &
                          marbl_varname=marbl_varname, field_units=units,               &
                          driver_varname='atm_ephyto5UVB', rank=2, id=n)

            case ('Net Inhibition Phyto5UVB')
            EPHYTO5UVB_NET_col_frac_id = n
            call interior_tendency_forcings(n)%add_forcing_field(field_source='internal',  &
                          marbl_varname=marbl_varname, field_units=units,               &
                          driver_varname='atm_ephyto5UVB_net', rank=2, id=n)


           case ('Inhibition Phyto5UVC')
            EPHYTO5UVC_col_frac_id = n
            call interior_tendency_forcings(n)%add_forcing_field(field_source='internal',  &
                          marbl_varname=marbl_varname, field_units=units,               &
                          driver_varname='atm_ephyto5UVC', rank=2, id=n)

            case ('Net Inhibition Phyto5UVC')
            EPHYTO5UVC_NET_col_frac_id = n
            call interior_tendency_forcings(n)%add_forcing_field(field_source='internal',  &
                          marbl_varname=marbl_varname, field_units=units,               &
                          driver_varname='atm_ephyto5UVC_net', rank=2, id=n)


!           case ('UV Inhibition Phyto5') ! COUPE ADDED -LORENZO ET AL 2019
!            EPHYTO5_col_frac_id = n
!            call interior_tendency_forcings(n)%add_forcing_field(field_source='internal',  &
!                          marbl_varname=marbl_varname, field_units=units,               &
!                          driver_varname='atm_ephyto5', rank=2, id=n)
!
!            case ('Net UV Inhibition Phyto5') ! COUPE ADDED -LORENZO ET AL 2019
!            EPHYTO5_NET_col_frac_id = n
!            call interior_tendency_forcings(n)%add_forcing_field(field_source='internal',  &
!                          marbl_varname=marbl_varname, field_units=units,               &
!                          driver_varname='atm_ephyto5_net', rank=2, id=n)


          ! Guan and Gao (2010) Emiliania huxleyi
           !case ('Inhibition Phyto6UVA') 
           ! PHYTO6UVA_col_frac_id = n
           ! call interior_tendency_forcings(n)%add_forcing_field(field_source='internal',  &
           !               marbl_varname=marbl_varname, field_units=units,               &
           !               driver_varname='atm_ephyto6UVA', rank=2, id=n)
!
!            case ('Net Inhibition Phyto6UVA') 
!            EPHYTO6UVA_NET_col_frac_id = n
!            call interior_tendency_forcings(n)%add_forcing_field(field_source='internal',  &
!                          marbl_varname=marbl_varname, field_units=units,               &
!                          driver_varname='atm_ephyto6UVA_net', rank=2, id=n)


 !          case ('Inhibition Phyto6UVB') 
 !           EPHYTO6UVB_col_frac_id = n
 !           call interior_tendency_forcings(n)%add_forcing_field(field_source='internal',  &
 !                         marbl_varname=marbl_varname, field_units=units,               &
 !                         driver_varname='atm_ephyto6UVB', rank=2, id=n)

  !          case ('Net Inhibition Phyto6UVB') 
  !          EPHYTO6UVB_NET_col_frac_id = n
  !          call interior_tendency_forcings(n)%add_forcing_field(field_source='internal',  &
  !                        marbl_varname=marbl_varname, field_units=units,               &
  !                        driver_varname='atm_ephyto6UVB_net', rank=2, id=n)


   !        case ('Inhibition Phyto6UVC') 
   !         EPHYTO6UVC_col_frac_id = n
   !         call interior_tendency_forcings(n)%add_forcing_field(field_source='internal',  &
   !                       marbl_varname=marbl_varname, field_units=units,               &
   !                       driver_varname='atm_ephyto6UVC', rank=2, id=n)
!
!            case ('Net Inhibition Phyto6UVC') 
!            EPHYTO6UVC_NET_col_frac_id = n
!            call interior_tendency_forcings(n)%add_forcing_field(field_source='internal',  &
!                          marbl_varname=marbl_varname, field_units=units,               &
!                          driver_varname='atm_ephyto6UVC_net', rank=2, id=n)


         ! Neale and Thomas (2014) - Synechococcus (small phytoplankton PFT)

           case ('Inhibition Phyto7UVA')
            EPHYTO7UVA_col_frac_id = n
            call interior_tendency_forcings(n)%add_forcing_field(field_source='internal',  &
                          marbl_varname=marbl_varname, field_units=units,               &
                          driver_varname='atm_ephyto7UVA', rank=2, id=n)

            case ('Net Inhibition Phyto7UVA')
            EPHYTO7UVA_NET_col_frac_id = n
            call interior_tendency_forcings(n)%add_forcing_field(field_source='internal',  &
                          marbl_varname=marbl_varname, field_units=units,               &
                          driver_varname='atm_ephyto7UVA_net', rank=2, id=n)


           case ('Inhibition Phyto7UVB')
            EPHYTO7UVB_col_frac_id = n
            call interior_tendency_forcings(n)%add_forcing_field(field_source='internal',  &
                          marbl_varname=marbl_varname, field_units=units,               &
                          driver_varname='atm_ephyto7UVB', rank=2, id=n)

            case ('Net Inhibition Phyto7UVB')
            EPHYTO7UVB_NET_col_frac_id = n
            call interior_tendency_forcings(n)%add_forcing_field(field_source='internal',  &
                          marbl_varname=marbl_varname, field_units=units,               &
                          driver_varname='atm_ephyto7UVB_net', rank=2, id=n)


           case ('Inhibition Phyto7UVC')
            EPHYTO7UVC_col_frac_id = n
            call interior_tendency_forcings(n)%add_forcing_field(field_source='internal',  &
                          marbl_varname=marbl_varname, field_units=units,               &
                          driver_varname='atm_ephyto7UVC', rank=2, id=n)

            case ('Net Inhibition Phyto7UVC')
            EPHYTO7UVC_NET_col_frac_id = n
            call interior_tendency_forcings(n)%add_forcing_field(field_source='internal',  &
                          marbl_varname=marbl_varname, field_units=units,               &
                          driver_varname='atm_ephyto7UVC_net', rank=2, id=n)
  ...
  subroutine ecosys_forcing_set_interior_time_varying_forcing_data( &
    ...
    use forcing_fields        , only : ATM_EPHYTO1UVA,ATM_EPHYTO1UVB,ATM_EPHYTO1UVC !, ATM_EPHYTO1_NET,ATM_EPHYTO4,ATM_EPHYTO4_NET,ATM_EPHYTO5,ATM_EPHYTO5_NET ! COUPE ADDED - PASS 3D FIELD IN 
    use forcing_fields        , only : ATM_EPHYTO4UVA,ATM_EPHYTO4UVB,ATM_EPHYTO4UVC
    use forcing_fields        , only : ATM_EPHYTO5UVA,ATM_EPHYTO5UVB,ATM_EPHYTO5UVC
    use forcing_fields        , only : ATM_EPHYTO6UVA,ATM_EPHYTO6UVB,ATM_EPHYTO6UVC
    use forcing_fields        , only : ATM_EPHYTO7UVA,ATM_EPHYTO7UVB,ATM_EPHYTO7UVC
    use forcing_fields        , only : ATM_EPHYTO1UVA_NET,ATM_EPHYTO1UVB_NET,ATM_EPHYTO1UVC_NET !, ATM_EPHYTO1_NET,ATM_EPHYTO4,ATM_EPHYTO4_NET,ATM_EPHYTO5,ATM_EPHYTO5_NET ! COUPE ADDED - PASS 3D FIELD IN 
    use forcing_fields        , only : ATM_EPHYTO4UVA_NET,ATM_EPHYTO4UVB_NET,ATM_EPHYTO4UVC_NET
    use forcing_fields        , only : ATM_EPHYTO5UVA_NET,ATM_EPHYTO5UVB_NET,ATM_EPHYTO5UVC_NET
    use forcing_fields        , only : ATM_EPHYTO6UVA_NET,ATM_EPHYTO6UVB_NET,ATM_EPHYTO6UVC_NET
    use forcing_fields        , only : ATM_EPHYTO7UVA_NET,ATM_EPHYTO7UVB_NET,ATM_EPHYTO7UVC_NET
    ...
    real(r8), dimension(nx_block, ny_block, mcog_nbins, nblocks_clinic), intent(in) :: QSW_BIN ! COUPE ADDED     
    !real(r8), dimension(nx_block, ny_block, max_blocks_clinic), intent(in) :: ATM_EPHYTO1 ! COUPE ADDED
...
!!!                metadata      => interior_tendency_forcings(field_index)%metadata)
          select case (trim(interior_tendency_forcings(field_index)%metadata%field_source))
            case('internal')
              ...
              else if (field_index .eq. EPHYTO1UVA_col_frac_id) then 
                  interior_tendency_forcings(field_index)%field_0d(:,:,iblock) = ATM_EPHYTO1UVA(:,:,iblock)! *1.0_r8
              else if (field_index .eq. EPHYTO1UVB_col_frac_id) then 
                  interior_tendency_forcings(field_index)%field_0d(:,:,iblock) = ATM_EPHYTO1UVB(:,:,iblock)! *1.0_r8
              else if (field_index .eq. EPHYTO1UVC_col_frac_id) then 
                  interior_tendency_forcings(field_index)%field_0d(:,:,iblock) = ATM_EPHYTO1UVC(:,:,iblock)! *1.0_r8
              else if (field_index .eq. EPHYTO1UVA_NET_col_frac_id) then 
                  interior_tendency_forcings(field_index)%field_0d(:,:,iblock) = ATM_EPHYTO1UVA_NET(:,:,iblock)! *1.0_r8
              else if (field_index .eq. EPHYTO1UVB_NET_col_frac_id) then 
                  interior_tendency_forcings(field_index)%field_0d(:,:,iblock) = ATM_EPHYTO1UVB_NET(:,:,iblock)! *1.0_r8
              else if (field_index .eq. EPHYTO1UVC_NET_col_frac_id) then 
                  interior_tendency_forcings(field_index)%field_0d(:,:,iblock) = ATM_EPHYTO1UVC_NET(:,:,iblock)! *1.0_r8

              else if (field_index .eq. EPHYTO4UVA_col_frac_id) then 
                  interior_tendency_forcings(field_index)%field_0d(:,:,iblock) = ATM_EPHYTO4UVA(:,:,iblock)! *1.0_r8
              else if (field_index .eq. EPHYTO4UVB_col_frac_id) then 
                  interior_tendency_forcings(field_index)%field_0d(:,:,iblock) = ATM_EPHYTO4UVB(:,:,iblock)! *1.0_r8
              else if (field_index .eq. EPHYTO4UVC_col_frac_id) then 
                  interior_tendency_forcings(field_index)%field_0d(:,:,iblock) = ATM_EPHYTO4UVC(:,:,iblock)! *1.0_r8
              else if (field_index .eq. EPHYTO4UVA_NET_col_frac_id) then 
                  interior_tendency_forcings(field_index)%field_0d(:,:,iblock) = ATM_EPHYTO4UVA_NET(:,:,iblock)! *1.0_r8
              else if (field_index .eq. EPHYTO4UVB_NET_col_frac_id) then 
                  interior_tendency_forcings(field_index)%field_0d(:,:,iblock) = ATM_EPHYTO4UVB_NET(:,:,iblock)! *1.0_r8
              else if (field_index .eq. EPHYTO4UVC_NET_col_frac_id) then 
                  interior_tendency_forcings(field_index)%field_0d(:,:,iblock) = ATM_EPHYTO4UVC_NET(:,:,iblock)! *1.0_r8

              else if (field_index .eq. EPHYTO5UVA_col_frac_id) then 
                  interior_tendency_forcings(field_index)%field_0d(:,:,iblock) = ATM_EPHYTO5UVA(:,:,iblock)! *1.0_r8
              else if (field_index .eq. EPHYTO5UVB_col_frac_id) then 
                  interior_tendency_forcings(field_index)%field_0d(:,:,iblock) = ATM_EPHYTO5UVB(:,:,iblock)! *1.0_r8
              else if (field_index .eq. EPHYTO5UVC_col_frac_id) then 
                  interior_tendency_forcings(field_index)%field_0d(:,:,iblock) = ATM_EPHYTO5UVC(:,:,iblock)! *1.0_r8
              else if (field_index .eq. EPHYTO5UVA_NET_col_frac_id) then 
                  interior_tendency_forcings(field_index)%field_0d(:,:,iblock) = ATM_EPHYTO5UVA_NET(:,:,iblock)! *1.0_r8
              else if (field_index .eq. EPHYTO5UVB_NET_col_frac_id) then 
                  interior_tendency_forcings(field_index)%field_0d(:,:,iblock) = ATM_EPHYTO5UVB_NET(:,:,iblock)! *1.0_r8
              else if (field_index .eq. EPHYTO5UVC_NET_col_frac_id) then 
                  interior_tendency_forcings(field_index)%field_0d(:,:,iblock) = ATM_EPHYTO5UVC_NET(:,:,iblock)! *1.0_r8

              !else if (field_index .eq. EPHYTO6UVA_col_frac_id) then 
              !    interior_tendency_forcings(field_index)%field_0d(:,:,iblock) = ATM_EPHYTO6UVA(:,:,iblock)! *1.0_r8
              !else if (field_index .eq. EPHYTO6UVB_col_frac_id) then 
              !    interior_tendency_forcings(field_index)%field_0d(:,:,iblock) = ATM_EPHYTO6UVB(:,:,iblock)! *1.0_r8
              !else if (field_index .eq. EPHYTO6UVC_col_frac_id) then 
              !    interior_tendency_forcings(field_index)%field_0d(:,:,iblock) = ATM_EPHYTO6UVC(:,:,iblock)! *1.0_r8
              !else if (field_index .eq. EPHYTO6UVA_NET_col_frac_id) then 
              !    interior_tendency_forcings(field_index)%field_0d(:,:,iblock) = ATM_EPHYTO6UVA_NET(:,:,iblock)! *1.0_r8
              !else if (field_index .eq. EPHYTO6UVB_NET_col_frac_id) then 
              !    interior_tendency_forcings(field_index)%field_0d(:,:,iblock) = ATM_EPHYTO6UVB_NET(:,:,iblock)! *1.0_r8
              !else if (field_index .eq. EPHYTO6UVC_NET_col_frac_id) then 
              !    interior_tendency_forcings(field_index)%field_0d(:,:,iblock) = ATM_EPHYTO6UVC_NET(:,:,iblock)! *1.0_r8

              else if (field_index .eq. EPHYTO7UVA_col_frac_id) then 
                  interior_tendency_forcings(field_index)%field_0d(:,:,iblock) = ATM_EPHYTO7UVA(:,:,iblock)! *1.0_r8
              else if (field_index .eq. EPHYTO7UVB_col_frac_id) then 
                  interior_tendency_forcings(field_index)%field_0d(:,:,iblock) = ATM_EPHYTO7UVB(:,:,iblock)! *1.0_r8
              else if (field_index .eq. EPHYTO7UVC_col_frac_id) then 
                  interior_tendency_forcings(field_index)%field_0d(:,:,iblock) = ATM_EPHYTO7UVC(:,:,iblock)! *1.0_r8
              else if (field_index .eq. EPHYTO7UVA_NET_col_frac_id) then 
                  interior_tendency_forcings(field_index)%field_0d(:,:,iblock) = ATM_EPHYTO7UVA_NET(:,:,iblock)! *1.0_r8
              else if (field_index .eq. EPHYTO7UVB_NET_col_frac_id) then 
                  interior_tendency_forcings(field_index)%field_0d(:,:,iblock) = ATM_EPHYTO7UVB_NET(:,:,iblock)! *1.0_r8
              else if (field_index .eq. EPHYTO7UVC_NET_col_frac_id) then 
                  interior_tendency_forcings(field_index)%field_0d(:,:,iblock) = ATM_EPHYTO7UVC_NET(:,:,iblock)! *1.0_r8

              !else if (field_index .eq. EPHYTO1_col_frac_id) then ! COUPE ADDED
              !    interior_tendency_forcings(field_index)%field_0d(:,:,iblock) = ATM_EPHYTO1(:,:,iblock)! *1.0_r8
              !else if (field_index .eq. EPHYTO1_NET_col_frac_id) then ! COUPE ADDED NET EINH
              !    interior_tendency_forcings(field_index)%field_0d(:,:,iblock) = ATM_EPHYTO1_NET(:,:,iblock)! *1.0_r8
             ! else if (field_index .eq. EPHYTO3_col_frac_id) then ! ephyto3 COUPE ADDED - unsure if need end if statements ??
             !     interior_tendency_forcings(field_index)%field_0d(:,:,iblock) = ATM_EPHYTO3(:,:,iblock) 
              !else if (field_index .eq. EPHYTO4_col_frac_id) then ! COUPE ADDED - unsure if need end if statements ??
              !    interior_tendency_forcings(field_index)%field_0d(:,:,iblock) = ATM_EPHYTO4(:,:,iblock)!*1.0_r8
              !else if (field_index .eq. EPHYTO4_NET_col_frac_id) then ! COUPE ADDED - unsure if need end if statements ??
              !    interior_tendency_forcings(field_index)%field_0d(:,:,iblock) = ATM_EPHYTO4_NET(:,:,iblock)!*1.0_r8
              !else if (field_index .eq. EPHYTO5_col_frac_id) then ! ephyto5
              !    interior_tendency_forcings(field_index)%field_0d(:,:,iblock) = ATM_EPHYTO5(:,:,iblock)
              !else if (field_index .eq. EPHYTO5_NET_col_frac_id) then ! ephyto5
              !    interior_tendency_forcings(field_index)%field_0d(:,:,iblock) = ATM_EPHYTO5_NET(:,:,iblock)
