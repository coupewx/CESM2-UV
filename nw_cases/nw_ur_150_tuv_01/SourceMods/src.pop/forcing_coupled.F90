...
! QL, 150526, LAMULT, USTOKES and VSTOKES
   ...
   call POP_HaloUpdate(ATM_PAR,POP_haloClinic, &
                       POP_gridHorzLocCenter,                   &
                       POP_fieldKindScalar, errorCode,          &
                       fillValue = 0.0_POP_r8)
   ...
   if (errorCode /= POP_Success) then
      call POP_ErrorSet(errorCode, &
         'update_ghost_cells_coupler: error updating ATM_PAR')
      return
   endif

   call POP_HaloUpdate(ATM_PAR_FAKE,POP_haloClinic, &
                       POP_gridHorzLocCenter,                   &
                       POP_fieldKindScalar, errorCode,          &
                       fillValue = 0.0_POP_r8)
   ...
   if (errorCode /= POP_Success) then
      call POP_ErrorSet(errorCode, &
         'update_ghost_cells_coupler: error updating ATM_PAR_FAKE')
      return
   endif

!   call POP_HaloUpdate(ATM_EPHYTO1,POP_haloClinic, &
!                       POP_gridHorzLocCenter,                   &
!                       POP_fieldKindScalar, errorCode,          &
!                       fillValue = 0.0_POP_r8)
!
!   if (errorCode /= POP_Success) then
!      call POP_ErrorSet(errorCode, &
!         'update_ghost_cells_coupler: error updating ATM_EPHYTO1')
!      return
!   endif
!
!   call POP_HaloUpdate(ATM_EPHYTO1_NET,POP_haloClinic, &
!                       POP_gridHorzLocCenter,                   &
!                       POP_fieldKindScalar, errorCode,          &
!                       fillValue = 0.0_POP_r8)
!
!   if (errorCode /= POP_Success) then
!      call POP_ErrorSet(errorCode, &
!         'update_ghost_cells_coupler: error updating ATM_EPHYTO1_NET')
!      return
!   endif
!
!   call POP_HaloUpdate(ATM_EPHYTO2,POP_haloClinic, &
!                       POP_gridHorzLocCenter,                   &
!                       POP_fieldKindScalar, errorCode,          &
!                       fillValue = 0.0_POP_r8)
!
!   if (errorCode /= POP_Success) then
!      call POP_ErrorSet(errorCode, &
!         'update_ghost_cells_coupler: error updating ATM_EPHYTO2')
!      return
!   endif
!
!   call POP_HaloUpdate(ATM_EPHYTO3,POP_haloClinic, &
!                       POP_gridHorzLocCenter,                   &
!                       POP_fieldKindScalar, errorCode,          &
!                       fillValue = 0.0_POP_r8)
!
!   if (errorCode /= POP_Success) then
!      call POP_ErrorSet(errorCode, &
!         'update_ghost_cells_coupler: error updating ATM_EPHYTO3')
!      return
!   endif
!
!
!   call POP_HaloUpdate(ATM_EPHYTO4,POP_haloClinic, &
!                       POP_gridHorzLocCenter,                   &
!                       POP_fieldKindScalar, errorCode,          &
!                       fillValue = 0.0_POP_r8)
!
!   if (errorCode /= POP_Success) then
!      call POP_ErrorSet(errorCode, &
!         'update_ghost_cells_coupler: error updating ATM_EPHYTO4')
!      return
!   endif
!
!   call POP_HaloUpdate(ATM_EPHYTO4_NET,POP_haloClinic, &
!                       POP_gridHorzLocCenter,                   &
!                       POP_fieldKindScalar, errorCode,          &
!                       fillValue = 0.0_POP_r8)
!
!   if (errorCode /= POP_Success) then
!      call POP_ErrorSet(errorCode, &
!         'update_ghost_cells_coupler: error updating ATM_EPHYTO4_NET')
!      return
!   endif
!
!   call POP_HaloUpdate(ATM_EPHYTO5,POP_haloClinic, &
!                       POP_gridHorzLocCenter,                   &
!                       POP_fieldKindScalar, errorCode,          &
!                       fillValue = 0.0_POP_r8)
!
!   if (errorCode /= POP_Success) then
!      call POP_ErrorSet(errorCode, &
!         'update_ghost_cells_coupler: error updating ATM_EPHYTO5')
!      return
!   endif
!
!   call POP_HaloUpdate(ATM_EPHYTO5_NET,POP_haloClinic, &
!                       POP_gridHorzLocCenter,                   &
!                       POP_fieldKindScalar, errorCode,          &
!                       fillValue = 0.0_POP_r8)
!
!   if (errorCode /= POP_Success) then
!      call POP_ErrorSet(errorCode, &
!         'update_ghost_cells_coupler: error updating ATM_EPHYTO5_NET')
!      return
!   endif


! new code with uva, uvb, uvc divisions and _NET prefix
! can leave all the above code in, will just call an error 

! ATM_EPHYTO1

   call POP_HaloUpdate(ATM_EPHYTO1UVA,POP_haloClinic, &
                       POP_gridHorzLocCenter,                   &
                       POP_fieldKindScalar, errorCode,          &
                       fillValue = 0.0_POP_r8)
   ...
   if (errorCode /= POP_Success) then
      call POP_ErrorSet(errorCode, &
         'update_ghost_cells_coupler: error updating ATM_EPHYTO1UVA')
      return
   endif

   call POP_HaloUpdate(ATM_EPHYTO1UVB,POP_haloClinic, &
                       POP_gridHorzLocCenter,                   &
                       POP_fieldKindScalar, errorCode,          &
                       fillValue = 0.0_POP_r8)
   ...
   if (errorCode /= POP_Success) then
      call POP_ErrorSet(errorCode, &
         'update_ghost_cells_coupler: error updating ATM_EPHYTO1UVB')
      return
   endif

   call POP_HaloUpdate(ATM_EPHYTO1UVC,POP_haloClinic, &
                       POP_gridHorzLocCenter,                   &
                       POP_fieldKindScalar, errorCode,          &
                       fillValue = 0.0_POP_r8)
   ...
   if (errorCode /= POP_Success) then
      call POP_ErrorSet(errorCode, &
         'update_ghost_cells_coupler: error updating ATM_EPHYTO1UVC')
      return
   endif


   call POP_HaloUpdate(ATM_EPHYTO1UVA_NET,POP_haloClinic, &
                       POP_gridHorzLocCenter,                   &
                       POP_fieldKindScalar, errorCode,          &
                       fillValue = 0.0_POP_r8)
   ...
   if (errorCode /= POP_Success) then
      call POP_ErrorSet(errorCode, &
         'update_ghost_cells_coupler: error updating ATM_EPHYTO1UVA_NET')
      return
   endif

   call POP_HaloUpdate(ATM_EPHYTO1UVB_NET,POP_haloClinic, &
                       POP_gridHorzLocCenter,                   &
                       POP_fieldKindScalar, errorCode,          &
                       fillValue = 0.0_POP_r8)
   ...
   if (errorCode /= POP_Success) then
      call POP_ErrorSet(errorCode, &
         'update_ghost_cells_coupler: error updating ATM_EPHYTO1UVB_NET')
      return
   endif

   call POP_HaloUpdate(ATM_EPHYTO1UVC_NET,POP_haloClinic, &
                       POP_gridHorzLocCenter,                   &
                       POP_fieldKindScalar, errorCode,          &
                       fillValue = 0.0_POP_r8)
   ...
   if (errorCode /= POP_Success) then
      call POP_ErrorSet(errorCode, &
         'update_ghost_cells_coupler: error updating ATM_EPHYTO1UVC_NET')
      return
   endif
...
! ATM_EPHYTO4
   ...
   call POP_HaloUpdate(ATM_EPHYTO4UVA,POP_haloClinic, &
                       POP_gridHorzLocCenter,                   &
                       POP_fieldKindScalar, errorCode,          &
                       fillValue = 0.0_POP_r8)
   ...
   if (errorCode /= POP_Success) then
      call POP_ErrorSet(errorCode, &
         'update_ghost_cells_coupler: error updating ATM_EPHYTO4UVA')
      return
   endif

   call POP_HaloUpdate(ATM_EPHYTO4UVB,POP_haloClinic, &
                       POP_gridHorzLocCenter,                   &
                       POP_fieldKindScalar, errorCode,          &
                       fillValue = 0.0_POP_r8)
   ...
   if (errorCode /= POP_Success) then
      call POP_ErrorSet(errorCode, &
         'update_ghost_cells_coupler: error updating ATM_EPHYTO4UVB')
      return
   endif

   call POP_HaloUpdate(ATM_EPHYTO4UVC,POP_haloClinic, &
                       POP_gridHorzLocCenter,                   &
                       POP_fieldKindScalar, errorCode,          &
                       fillValue = 0.0_POP_r8)
   ...
   if (errorCode /= POP_Success) then
      call POP_ErrorSet(errorCode, &
         'update_ghost_cells_coupler: error updating ATM_EPHYTO4UVC')
      return
   endif


   call POP_HaloUpdate(ATM_EPHYTO4UVA_NET,POP_haloClinic, &
                       POP_gridHorzLocCenter,                   &
                       POP_fieldKindScalar, errorCode,          &
                       fillValue = 0.0_POP_r8)
   ...
   if (errorCode /= POP_Success) then
      call POP_ErrorSet(errorCode, &
         'update_ghost_cells_coupler: error updating ATM_EPHYTO4UVA_NET')
      return
   endif

   call POP_HaloUpdate(ATM_EPHYTO4UVB_NET,POP_haloClinic, &
                       POP_gridHorzLocCenter,                   &
                       POP_fieldKindScalar, errorCode,          &
                       fillValue = 0.0_POP_r8)
   ...
   if (errorCode /= POP_Success) then
      call POP_ErrorSet(errorCode, &
         'update_ghost_cells_coupler: error updating ATM_EPHYTO4UVB_NET')
      return
   endif

   call POP_HaloUpdate(ATM_EPHYTO4UVC_NET,POP_haloClinic, &
                       POP_gridHorzLocCenter,                   &
                       POP_fieldKindScalar, errorCode,          &
                       fillValue = 0.0_POP_r8)
   ...
   if (errorCode /= POP_Success) then
      call POP_ErrorSet(errorCode, &
         'update_ghost_cells_coupler: error updating ATM_EPHYTO4UVC_NET')
      return
   endif
...
! ATM_EPHYTO5
   ...
   call POP_HaloUpdate(ATM_EPHYTO5UVA,POP_haloClinic, &
                       POP_gridHorzLocCenter,                   &
                       POP_fieldKindScalar, errorCode,          &
                       fillValue = 0.0_POP_r8)
   ...
   if (errorCode /= POP_Success) then
      call POP_ErrorSet(errorCode, &
         'update_ghost_cells_coupler: error updating ATM_EPHYTO5UVA')
      return
   endif

   call POP_HaloUpdate(ATM_EPHYTO5UVB,POP_haloClinic, &
                       POP_gridHorzLocCenter,                   &
                       POP_fieldKindScalar, errorCode,          &
                       fillValue = 0.0_POP_r8)
   ...
   if (errorCode /= POP_Success) then
      call POP_ErrorSet(errorCode, &
         'update_ghost_cells_coupler: error updating ATM_EPHYTO5UVB')
      return
   endif

   call POP_HaloUpdate(ATM_EPHYTO5UVC,POP_haloClinic, &
                       POP_gridHorzLocCenter,                   &
                       POP_fieldKindScalar, errorCode,          &
                       fillValue = 0.0_POP_r8)
   ...
   if (errorCode /= POP_Success) then
      call POP_ErrorSet(errorCode, &
         'update_ghost_cells_coupler: error updating ATM_EPHYTO5UVC')
      return
   endif


   call POP_HaloUpdate(ATM_EPHYTO5UVA_NET,POP_haloClinic, &
                       POP_gridHorzLocCenter,                   &
                       POP_fieldKindScalar, errorCode,          &
                       fillValue = 0.0_POP_r8)
   ...
   if (errorCode /= POP_Success) then
      call POP_ErrorSet(errorCode, &
         'update_ghost_cells_coupler: error updating ATM_EPHYTO5UVA_NET')
      return
   endif

   call POP_HaloUpdate(ATM_EPHYTO5UVB_NET,POP_haloClinic, &
                       POP_gridHorzLocCenter,                   &
                       POP_fieldKindScalar, errorCode,          &
                       fillValue = 0.0_POP_r8)
   ...
   if (errorCode /= POP_Success) then
      call POP_ErrorSet(errorCode, &
         'update_ghost_cells_coupler: error updating ATM_EPHYTO5UVB_NET')
      return
   endif

   call POP_HaloUpdate(ATM_EPHYTO5UVC_NET,POP_haloClinic, &
                       POP_gridHorzLocCenter,                   &
                       POP_fieldKindScalar, errorCode,          &
                       fillValue = 0.0_POP_r8)
   ...
   if (errorCode /= POP_Success) then
      call POP_ErrorSet(errorCode, &
         'update_ghost_cells_coupler: error updating ATM_EPHYTO5UVC_NET')
      return
   endif
...
!   call POP_HaloUpdate(ATM_EPHYTO6UVA,POP_haloClinic, &
!                       POP_gridHorzLocCenter,                   &
!                       POP_fieldKindScalar, errorCode,          &
!                       fillValue = 0.0_POP_r8)
...
!   if (errorCode /= POP_Success) then
!      call POP_ErrorSet(errorCode, &
!         'update_ghost_cells_coupler: error updating ATM_EPHYTO6UVA')
!      return
!   endif

!   call POP_HaloUpdate(ATM_EPHYTO6UVB,POP_haloClinic, &
!                       POP_gridHorzLocCenter,                   &
!                       POP_fieldKindScalar, errorCode,          &
!                       fillValue = 0.0_POP_r8)
 ...
 !  if (errorCode /= POP_Success) then
 !     call POP_ErrorSet(errorCode, &
 !        'update_ghost_cells_coupler: error updating ATM_EPHYTO6UVB')
 !     return
 !  endif

 !  call POP_HaloUpdate(ATM_EPHYTO6UVC,POP_haloClinic, &
 !                      POP_gridHorzLocCenter,                   &
 !                      POP_fieldKindScalar, errorCode,          &
 !                      fillValue = 0.0_POP_r8)
  ...
  ! if (errorCode /= POP_Success) then
  !    call POP_ErrorSet(errorCode, &
  !       'update_ghost_cells_coupler: error updating ATM_EPHYTO6UVC')
  !    return
  ! endif


 !  call POP_HaloUpdate(ATM_EPHYTO6UVA_NET,POP_haloClinic, &
 !                      POP_gridHorzLocCenter,                   &
 !                      POP_fieldKindScalar, errorCode,          &
 !                      fillValue = 0.0_POP_r8)
  ...
  ! if (errorCode /= POP_Success) then
  !    call POP_ErrorSet(errorCode, &
  !       'update_ghost_cells_coupler: error updating ATM_EPHYTO6UVA_NET')
  !    return
  ! endif

  ! call POP_HaloUpdate(ATM_EPHYTO6UVB_NET,POP_haloClinic, &
  !                     POP_gridHorzLocCenter,                   &
  !                     POP_fieldKindScalar, errorCode,          &
  !                     fillValue = 0.0_POP_r8)
  ...
  ! if (errorCode /= POP_Success) then
  !    call POP_ErrorSet(errorCode, &
  !       'update_ghost_cells_coupler: error updating ATM_EPHYTO6UVB_NET')
  !    return
  ! endif

  ! call POP_HaloUpdate(ATM_EPHYTO6UVC_NET,POP_haloClinic, &
  !                     POP_gridHorzLocCenter,                   &
  !                     POP_fieldKindScalar, errorCode,          &
  !                     fillValue = 0.0_POP_r8)
  ...
  ! if (errorCode /= POP_Success) then
  !    call POP_ErrorSet(errorCode, &
  !       'update_ghost_cells_coupler: error updating ATM_EPHYTO6UVC_NET')
  !    return
  ! endif
...
! ATM_EPHYTO7
   ...
   call POP_HaloUpdate(ATM_EPHYTO7UVA,POP_haloClinic, &
                       POP_gridHorzLocCenter,                   &
                       POP_fieldKindScalar, errorCode,          &
                       fillValue = 0.0_POP_r8)
   ...
   if (errorCode /= POP_Success) then
      call POP_ErrorSet(errorCode, &
         'update_ghost_cells_coupler: error updating ATM_EPHYTO7UVA')
      return
   endif

   call POP_HaloUpdate(ATM_EPHYTO7UVB,POP_haloClinic, &
                       POP_gridHorzLocCenter,                   &
                       POP_fieldKindScalar, errorCode,          &
                       fillValue = 0.0_POP_r8)
   ...
   if (errorCode /= POP_Success) then
      call POP_ErrorSet(errorCode, &
         'update_ghost_cells_coupler: error updating ATM_EPHYTO7UVB')
      return
   endif

   call POP_HaloUpdate(ATM_EPHYTO7UVC,POP_haloClinic, &
                       POP_gridHorzLocCenter,                   &
                       POP_fieldKindScalar, errorCode,          &
                       fillValue = 0.0_POP_r8)
   ...
   if (errorCode /= POP_Success) then
      call POP_ErrorSet(errorCode, &
         'update_ghost_cells_coupler: error updating ATM_EPHYTO7UVC')
      return
   endif


   call POP_HaloUpdate(ATM_EPHYTO7UVA_NET,POP_haloClinic, &
                       POP_gridHorzLocCenter,                   &
                       POP_fieldKindScalar, errorCode,          &
                       fillValue = 0.0_POP_r8)
   ...
   if (errorCode /= POP_Success) then
      call POP_ErrorSet(errorCode, &
         'update_ghost_cells_coupler: error updating ATM_EPHYTO7UVA_NET')
      return
   endif

   call POP_HaloUpdate(ATM_EPHYTO7UVB_NET,POP_haloClinic, &
                       POP_gridHorzLocCenter,                   &
                       POP_fieldKindScalar, errorCode,          &
                       fillValue = 0.0_POP_r8)
   ...
   if (errorCode /= POP_Success) then
      call POP_ErrorSet(errorCode, &
         'update_ghost_cells_coupler: error updating ATM_EPHYTO7UVB_NET')
      return
   endif

   call POP_HaloUpdate(ATM_EPHYTO7UVC_NET,POP_haloClinic, &
                       POP_gridHorzLocCenter,                   &
                       POP_fieldKindScalar, errorCode,          &
                       fillValue = 0.0_POP_r8)
   ...
   if (errorCode /= POP_Success) then
      call POP_ErrorSet(errorCode, &
         'update_ghost_cells_coupler: error updating ATM_EPHYTO7UVC_NET')
      return
   endif
