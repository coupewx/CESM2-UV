...
contains
  ...
  subroutine prep_ocn_merge( flux_epbalfact, a2x_o, i2x_o, r2x_o, w2x_o, g2x_o, xao_o, &
    ...
    real(r8) :: incoming_uva, incoming_uvb, incoming_uvc
    real(r8) :: ATM_PAR !,ATM_PAR_FAKE !,incoming_ephyto1,incoming_ephyto4,incoming_ephyto5
    real(r8) :: incoming_ephyto1UVA,incoming_ephyto1UVB,incoming_ephyto1UVC
    real(r8) :: incoming_ephyto4UVA,incoming_ephyto4UVB,incoming_ephyto4UVC
    real(r8) :: incoming_ephyto5UVA,incoming_ephyto5UVB,incoming_ephyto5UVC
    !real(r8) :: incoming_ephyto6UVA,incoming_ephyto6UVB,incoming_ephyto6UVC
    real(r8) :: incoming_ephyto7UVA,incoming_ephyto7UVB,incoming_ephyto7UVC
    ! PAR from TUV
    ...
    integer, save :: index_a2x_Faxa_par  ! PAR variable, add fake one?
    !integer, save :: index_a2x_Faxa_par_fake  ! PAR variable, add fake one?
    integer, save :: index_a2x_Faxa_uva
    integer, save :: index_a2x_Faxa_uvb
    integer, save :: index_a2x_Faxa_uvc
    integer, save :: index_a2x_Sa_ephyto1UVA ! cullen e*inh for diatoms
    integer, save :: index_a2x_Sa_ephyto1UVB
    integer, save :: index_a2x_Sa_ephyto1UVC
    integer, save :: index_a2x_Sa_ephyto4UVA
    integer, save :: index_a2x_Sa_ephyto4UVB
    integer, save :: index_a2x_Sa_ephyto4UVC
    integer, save :: index_a2x_Sa_ephyto5UVA
    integer, save :: index_a2x_Sa_ephyto5UVB
    integer, save :: index_a2x_Sa_ephyto5UVC
    !integer, save :: index_a2x_Sa_ephyto6UVA
    !integer, save :: index_a2x_Sa_ephyto6UVB
    !integer, save :: index_a2x_Sa_ephyto6UVC
    integer, save :: index_a2x_Sa_ephyto7UVA
    integer, save :: index_a2x_Sa_ephyto7UVB
    integer, save :: index_a2x_Sa_ephyto7UVC

    ! calculation of net terms 
    integer, save :: index_x2o_Sa_ephyto1UVA_net 
    integer, save :: index_x2o_Sa_ephyto1UVB_net
    integer, save :: index_x2o_Sa_ephyto1UVC_net
    integer, save :: index_x2o_Sa_ephyto4UVA_net
    integer, save :: index_x2o_Sa_ephyto4UVB_net
    integer, save :: index_x2o_Sa_ephyto4UVC_net
    integer, save :: index_x2o_Sa_ephyto5UVA_net
    integer, save :: index_x2o_Sa_ephyto5UVB_net
    integer, save :: index_x2o_Sa_ephyto5UVC_net
    !integer, save :: index_x2o_Sa_ephyto6UVA_net
    !integer, save :: index_x2o_Sa_ephyto6UVB_net
    !integer, save :: index_x2o_Sa_ephyto6UVC_net
    integer, save :: index_x2o_Sa_ephyto7UVA_net
    integer, save :: index_x2o_Sa_ephyto7UVB_net
    integer, save :: index_x2o_Sa_ephyto7UVC_net


    !integer, save :: index_x2o_Sa_ephyto1_net ! net cullen e*inh for diatoms ( albedo consider )
    !integer, save :: index_a2x_Sa_ephyto4 ! e*inh 
    !integer, save :: index_x2o_Sa_ephyto4_net ! net e*inh( albedo consider )
    !integer, save :: index_a2x_Sa_ephyto5 ! e*inh
    !integer, save :: index_x2o_Sa_ephyto5_net ! net e*inh  ( albedo consider )
    logical :: iamroot
    ...
    if (first_time) then
       ...
       index_a2x_Faxa_par       = mct_aVect_indexRA(a2x_o,'Faxa_par') !Coupe added this 2/1/23
       !index_a2x_Faxa_par_fake       = mct_aVect_indexRA(a2x_o,'Faxa_par_fake') !Coupe added this 2/1/23
       !index_a2x_Sa_ephyto1    = mct_aVect_indexRA(a2x_o,'Sa_ephyto1') ! cullen diatoms e*inh coupe added 3/9/24
       !index_x2o_Sa_ephyto1_net = mct_aVect_indexRA(x2o_o,'Sa_ephyto1_net') ! cullen diatoms net e*inh coupe added 3/9/24
       !index_a2x_Sa_ephyto4    = mct_aVect_indexRA(a2x_o,'Sa_ephyto4') !  e*inh coupe added 3/9/24
       !index_x2o_Sa_ephyto4_net = mct_aVect_indexRA(x2o_o,'Sa_ephyto4_net') !  net e*inh coupe added 3/9/24
       !index_a2x_Sa_ephyto5    = mct_aVect_indexRA(a2x_o,'Sa_ephyto5') !  e*inh coupe added 3/9/24
       !index_x2o_Sa_ephyto5_net = mct_aVect_indexRA(x2o_o,'Sa_ephyto5_net') !  net e*inh coupe added 3/9/24

       index_a2x_Faxa_uva=mct_aVect_indexRA(a2x_o,'Faxa_uva')
       index_a2x_Faxa_uvb=mct_aVect_indexRA(a2x_o,'Faxa_uvb')
       index_a2x_Faxa_uvc=mct_aVect_indexRA(a2x_o,'Faxa_uvc')
       index_a2x_Sa_ephyto1UVA=mct_aVect_indexRA(a2x_o,'Sa_ephyto1UVA')
       index_a2x_Sa_ephyto1UVB=mct_aVect_indexRA(a2x_o,'Sa_ephyto1UVB')
       index_a2x_Sa_ephyto1UVC=mct_aVect_indexRA(a2x_o,'Sa_ephyto1UVC')
       index_a2x_Sa_ephyto4UVA=mct_aVect_indexRA(a2x_o,'Sa_ephyto4UVA')
       index_a2x_Sa_ephyto4UVB=mct_aVect_indexRA(a2x_o,'Sa_ephyto4UVB')
       index_a2x_Sa_ephyto4UVC=mct_aVect_indexRA(a2x_o,'Sa_ephyto4UVC')
       index_a2x_Sa_ephyto5UVA=mct_aVect_indexRA(a2x_o,'Sa_ephyto5UVA')
       index_a2x_Sa_ephyto5UVB=mct_aVect_indexRA(a2x_o,'Sa_ephyto5UVB')
       index_a2x_Sa_ephyto5UVC=mct_aVect_indexRA(a2x_o,'Sa_ephyto5UVC')
       !index_a2x_Sa_ephyto6UVA=mct_aVect_indexRA(a2x_o,'Sa_ephyto6UVA')
       !index_a2x_Sa_ephyto6UVB=mct_aVect_indexRA(a2x_o,'Sa_ephyto6UVB')
       !index_a2x_Sa_ephyto6UVC=mct_aVect_indexRA(a2x_o,'Sa_ephyto6UVC')
       index_a2x_Sa_ephyto7UVA=mct_aVect_indexRA(a2x_o,'Sa_ephyto7UVA')
       index_a2x_Sa_ephyto7UVB=mct_aVect_indexRA(a2x_o,'Sa_ephyto7UVB')
       index_a2x_Sa_ephyto7UVC=mct_aVect_indexRA(a2x_o,'Sa_ephyto7UVC')
       ! net terms need to be initialized to be sent to the ocean 
       index_x2o_Sa_ephyto1UVA_net=mct_aVect_indexRA(x2o_o,'Sa_ephyto1UVA_net')
       index_x2o_Sa_ephyto1UVB_net=mct_aVect_indexRA(x2o_o,'Sa_ephyto1UVB_net')
       index_x2o_Sa_ephyto1UVC_net=mct_aVect_indexRA(x2o_o,'Sa_ephyto1UVC_net')    
       index_x2o_Sa_ephyto4UVA_net=mct_aVect_indexRA(x2o_o,'Sa_ephyto4UVA_net')
       index_x2o_Sa_ephyto4UVB_net=mct_aVect_indexRA(x2o_o,'Sa_ephyto4UVB_net')
       index_x2o_Sa_ephyto4UVC_net=mct_aVect_indexRA(x2o_o,'Sa_ephyto4UVC_net')
       index_x2o_Sa_ephyto5UVA_net=mct_aVect_indexRA(x2o_o,'Sa_ephyto5UVA_net')
       index_x2o_Sa_ephyto5UVB_net=mct_aVect_indexRA(x2o_o,'Sa_ephyto5UVB_net')
       index_x2o_Sa_ephyto5UVC_net=mct_aVect_indexRA(x2o_o,'Sa_ephyto5UVC_net')
       !index_x2o_Sa_ephyto6UVA_net=mct_aVect_indexRA(x2o_o,'Sa_ephyto6UVA_net')
       !index_x2o_Sa_ephyto6UVB_net=mct_aVect_indexRA(x2o_o,'Sa_ephyto6UVB_net')
       !index_x2o_Sa_ephyto6UVC_net=mct_aVect_indexRA(x2o_o,'Sa_ephyto6UVC_net')
       index_x2o_Sa_ephyto7UVA_net=mct_aVect_indexRA(x2o_o,'Sa_ephyto7UVA_net')
       index_x2o_Sa_ephyto7UVB_net=mct_aVect_indexRA(x2o_o,'Sa_ephyto7UVB_net')
       index_x2o_Sa_ephyto7UVC_net=mct_aVect_indexRA(x2o_o,'Sa_ephyto7UVC_net')
       ...
       do ko = 1,noflds
          ...
          if (trim(field_ocn(ko)) == 'Foxx_swnet' .or. &
               ...
               trim(field_ocn(ko)) == 'Faxa_uva' .or. &
               trim(field_ocn(ko)) == 'Faxa_uvb' .or. &
               trim(field_ocn(ko)) == 'Faxa_uvc' .or. & 
               trim(field_ocn(ko)) == 'Sa_ephyto1UVA_net' .or. &
               trim(field_ocn(ko)) == 'Sa_ephyto1UVB_net' .or. &
               trim(field_ocn(ko)) == 'Sa_ephyto1UVC_net' .or. &
               trim(field_ocn(ko)) == 'Sa_ephyto4UVA_net' .or. &
               trim(field_ocn(ko)) == 'Sa_ephyto4UVB_net' .or. &
               trim(field_ocn(ko)) == 'Sa_ephyto4UVC_net' .or. &
               trim(field_ocn(ko)) == 'Sa_ephyto5UVA_net' .or. &
               trim(field_ocn(ko)) == 'Sa_ephyto5UVB_net' .or. &
               trim(field_ocn(ko)) == 'Sa_ephyto5UVC_net' .or. &
               trim(field_ocn(ko)) == 'Sa_ephyto7UVA_net' .or. &
               trim(field_ocn(ko)) == 'Sa_ephyto7UVB_net' .or. &
               trim(field_ocn(ko)) == 'Sa_ephyto7UVC_net' .or. &
    ...
    do n = 1,lsize
       ...
       avsdr = xao_o%rAttr(index_xao_So_avsdr,n) ! albedo visible direct
       anidr = xao_o%rAttr(index_xao_So_anidr,n) ! albedo near infrared direct
       avsdf = xao_o%rAttr(index_xao_So_avsdf,n) ! albedo visible diffuse 
       anidf = xao_o%rAttr(index_xao_So_anidf,n) ! albedo near infrared diffuse 
      ...
      ! coupe adding albedo to ephyto1 (ephyto1_net)      ! coupe adding albedo to ephyto1 (ephyto1_net) - note avsdr is direct visible albedo

       incoming_uva = a2x_o%rAttr(index_a2x_Faxa_uva,n)* (1.0_R8 - avsdr)*(1.0_R8 -ifrac) ! a2x_o%rAttr(index_a2x_Faxa_swvdr,n) * (1.0_R8 - avsdr) 
       x2o_o%rAttr(index_a2x_Faxa_uva,n) = incoming_uva

       incoming_uvb = a2x_o%rAttr(index_a2x_Faxa_uvb,n)* (1.0_R8 - avsdr)*(1.0_R8 -ifrac)
       x2o_o%rAttr(index_a2x_Faxa_uvb,n) = incoming_uvb

       incoming_uvc = a2x_o%rAttr(index_a2x_Faxa_uvc,n)* (1.0_R8 - avsdr)*(1.0_R8 -ifrac)
       x2o_o%rAttr(index_a2x_Faxa_uvc,n) = incoming_uvc


       incoming_ephyto1UVA = a2x_o%rAttr(index_a2x_Sa_ephyto1UVA,n)
       x2o_o%rAttr(index_x2o_Sa_ephyto1UVA_net,n) = incoming_ephyto1UVA*(1.0_R8 - avsdr)*(1.0_R8 -ifrac)
       incoming_ephyto1UVB = a2x_o%rAttr(index_a2x_Sa_ephyto1UVB,n)
       x2o_o%rAttr(index_x2o_Sa_ephyto1UVB_net,n) = incoming_ephyto1UVB*(1.0_R8 - avsdr)*(1.0_R8 -ifrac)
       incoming_ephyto1UVC = a2x_o%rAttr(index_a2x_Sa_ephyto1UVC,n)
       x2o_o%rAttr(index_x2o_Sa_ephyto1UVC_net,n) = incoming_ephyto1UVC*(1.0_R8 - avsdr)*(1.0_R8 -ifrac)

       incoming_ephyto4UVA = a2x_o%rAttr(index_a2x_Sa_ephyto4UVA,n)
       x2o_o%rAttr(index_x2o_Sa_ephyto4UVA_net,n) = incoming_ephyto4UVA*(1.0_R8 - avsdr)*(1.0_R8 -ifrac)
       incoming_ephyto4UVB = a2x_o%rAttr(index_a2x_Sa_ephyto4UVB,n)
       x2o_o%rAttr(index_x2o_Sa_ephyto4UVB_net,n) = incoming_ephyto4UVB*(1.0_R8 - avsdr)*(1.0_R8 -ifrac)
       incoming_ephyto4UVC = a2x_o%rAttr(index_a2x_Sa_ephyto4UVC,n)
       x2o_o%rAttr(index_x2o_Sa_ephyto4UVC_net,n) = incoming_ephyto4UVC*(1.0_R8 - avsdr)*(1.0_R8 -ifrac)

       incoming_ephyto5UVA = a2x_o%rAttr(index_a2x_Sa_ephyto5UVA,n)
       x2o_o%rAttr(index_x2o_Sa_ephyto5UVA_net,n) = incoming_ephyto5UVA*(1.0_R8 - avsdr)*(1.0_R8 -ifrac)
       incoming_ephyto5UVB = a2x_o%rAttr(index_a2x_Sa_ephyto5UVB,n)
       x2o_o%rAttr(index_x2o_Sa_ephyto5UVB_net,n) = incoming_ephyto5UVB*(1.0_R8 - avsdr)*(1.0_R8 -ifrac)
       incoming_ephyto5UVC = a2x_o%rAttr(index_a2x_Sa_ephyto5UVC,n)
       x2o_o%rAttr(index_x2o_Sa_ephyto5UVC_net,n) = incoming_ephyto5UVC*(1.0_R8 - avsdr)*(1.0_R8 -ifrac)
   
       !incoming_ephyto6UVA = a2x_o%rAttr(index_a2x_Sa_ephyto6UVA,n)
       !x2o_o%rAttr(index_x2o_Sa_ephyto6UVA_net,n) = incoming_ephyto6UVA*(1.0_R8 - avsdr)*(1.0_R8 -ifrac)
       !incoming_ephyto6UVB = a2x_o%rAttr(index_a2x_Sa_ephyto6UVB,n)
       !x2o_o%rAttr(index_x2o_Sa_ephyto6UVB_net,n) = incoming_ephyto6UVB*(1.0_R8 - avsdr)*(1.0_R8 -ifrac)
       !incoming_ephyto6UVC = a2x_o%rAttr(index_a2x_Sa_ephyto6UVC,n)
       !x2o_o%rAttr(index_x2o_Sa_ephyto6UVC_net,n) = incoming_ephyto6UVC*(1.0_R8 - avsdr)*(1.0_R8 -ifrac)
        
       incoming_ephyto7UVA = a2x_o%rAttr(index_a2x_Sa_ephyto7UVA,n)
       x2o_o%rAttr(index_x2o_Sa_ephyto7UVA_net,n) = incoming_ephyto7UVA*(1.0_R8 - avsdr)*(1.0_R8 -ifrac)
       incoming_ephyto7UVB = a2x_o%rAttr(index_a2x_Sa_ephyto7UVB,n)
       x2o_o%rAttr(index_x2o_Sa_ephyto7UVB_net,n) = incoming_ephyto7UVB*(1.0_R8 - avsdr)*(1.0_R8 -ifrac)
       incoming_ephyto7UVC = a2x_o%rAttr(index_a2x_Sa_ephyto7UVC,n)
       x2o_o%rAttr(index_x2o_Sa_ephyto7UVC_net,n) = incoming_ephyto7UVC*(1.0_R8 - avsdr)*(1.0_R8 -ifrac)
