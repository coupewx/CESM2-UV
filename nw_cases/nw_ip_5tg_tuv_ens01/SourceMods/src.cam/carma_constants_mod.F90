...
module carma_constants_mod
  ...
  !! A minimum vlaue for gas concentration that is used during
  !! CARMASTATE_Create()
  real(kind=f), parameter :: MINGAS = 1e-16_f
...
! real(kind=f), parameter :: SMALL_PC = 1e-50_f
  ...
  !! Define molecular weight of carbon dioxide [ g / mole ]
  real(kind=f)            :: WTMOL_CO2
  
  !! Define molecular weight of sulfur dioxide [ g / mole ]
  real(kind=f)            :: WTMOL_SO2  

  !! Define molecular weight of ozone [ g / mole ]
  real(kind=f)            :: WTMOL_O3  

  !! Define molecular weight of hydroxl [ g / mole ]
  real(kind=f)            :: WTMOL_OH  = 17._f

  !! Define molecular weight of carbon [ g / mole ]
  real(kind=f)            :: WTMOL_C  = 12._f
  
  !! Define molecular weight of nitric oxide [ g / mole ]
  real(kind=f), parameter :: WTMOL_NO  = 30._f
