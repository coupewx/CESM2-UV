module seq_drydep_mod
  ...
  integer, public,  parameter :: n_species_table = 79      ! Number of species to work with
  ...
  logical, public  :: drydep_do_aq_nox = .false.           ! Include
  ...
  real(r8), public, parameter :: dheff(n_species_table*6) = &
       ...
       ,1.e+03_r8,      0._r8,0._r8     ,    0._r8,0._r8     ,    0._r8  &
       ,1.e+03_r8,      0._r8,0._r8     ,    0._r8,0._r8     ,    0._r8  &
       ,1.42e+00_r8,    0._r8,0._r8     ,    0._r8,0._r8     ,    0._r8  &
       ,4.76e+01_r8, 4900._r8,0._r8     ,    0._r8,0._r8     ,    0._r8  &
       /)
  ...
  real(r8), private, parameter :: mol_wgts(n_species_table) = &
       ...
       170.3_r8,      170.3_r8,      92.001_r8,     47.013_r8  /)
...
CONTAINS
  ...
  subroutine seq_drydep_readnl(NLFilename, ID, seq_drydep_fields)
    ...
    namelist /drydep_inparm/ drydep_list, drydep_method, drydep_do_aq_nox
    ...
    call shr_mpi_bcast( drydep_do_aq_nox, mpicom )
