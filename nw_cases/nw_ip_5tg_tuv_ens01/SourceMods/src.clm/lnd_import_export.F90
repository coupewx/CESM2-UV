...
contains
  ...
  subroutine lnd_import( bounds, x2l, glc_present, atm2lnd_inst, glc2lnd_inst)
    ...
    do g = bounds%begg,bounds%endg
      ...
      !atm2lnd_inst%forc_plant71_grc(g,1)            = x1l(index_x2l_Sa_plant71,i)   ! plant71 unitless
...
!CGB
  write(*,*) "sols=", atm2lnd_inst%forc_solad_grc(g,1:2)
  write(*,*) "soll=", atm2lnd_inst%forc_solai_grc(g,1:2)
